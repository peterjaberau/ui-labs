...
import { type Editor, useCompartment, viewToEditor } from '~/sg/shared/components/CodeMirrorEditor'
import type { SearchPatternType } from '~/sg/shared/graphql-operations'
import { Shortcut } from '~/sg/shared/react-shortcuts'
import { QueryChangeSource, type QueryState } from '~/sg/shared/search'
import { Button, Icon, Tooltip } from '~/sg/wildcard'
...
export const CodeMirrorQueryInputWrapper = forwardRef<Editor, PropsWithChildren<CodeMirrorQueryInputWrapperProps>>(
    (
        ...
        const { ref: inputContainerRef, height = 0 } : any = useResizeObserver({ box: 'border-box' } as any)
