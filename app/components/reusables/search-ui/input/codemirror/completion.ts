...
import { isDefined } from "~/sg/common"
import { SymbolKind } from "~/sg/shared/graphql-operations"
import { createFilterSuggestions, PREDICATE_REGEX, regexInsertText, repositoryInsertText } from "~/sg/shared/search/query/completion-utils"
import { decorate, toDecoration, type DecoratedToken } from "~/sg/shared/search/query/decoratedToken"
import { FILTERS, filterTypeKeys, resolveFilter, type FilterType } from "~/sg/shared/search/query/filters"
import { getSuggestionQuery } from "~/sg/shared/search/query/providers-utils"
import { scanSearchQuery } from "~/sg/shared/search/query/scanner"
import type { Filter, Token } from "~/sg/shared/search/query/token"
import type { SearchMatch } from "~/sg/shared/search/stream"
import { createSVGIcon } from "~/sg/shared/util/dom"
