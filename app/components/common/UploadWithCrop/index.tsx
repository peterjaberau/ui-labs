...
import { Cropper } from "../Copper"; // Ensure the path is correct
    ...
    <>
      <ProFormUploadButton
        ...
        fieldProps={{
          ...
          data: {
            userId: localStorage.getItem("userId"), // Pass additional data if needed
          },
          onChange: (info) => {
            if (info.file.status === "done") {
              if (info.file.response.code === 0) {
                message.success(info.file.response.message ?? "Upload successful");
              } else {
