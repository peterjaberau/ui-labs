 ...
 */
function openLinkInNewTab(url: string, event: Pick<MouseEvent, "ctrlKey" | "altKey" | "shiftKey" | "metaKey">, button: "primary" | "middle"): void {
 ...
 */
function onClickCodeExcerptHref(event: KeyboardEvent<HTMLElement> | MouseEvent<HTMLElement>, onClickHref: (href: string) => void): void {
  ...
  if (
    (event.type === "click" && !isTextSelectionEvent(event as MouseEvent<HTMLElement>) && (event as MouseEvent<HTMLElement>).button !== 1) ||
