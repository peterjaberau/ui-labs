...
import { NoResultsSectionID as SectionID } from '~/internals/development/sg/shared/settings/temporary/searchSidebar.ts'
...
import { Button, Link, Icon, H2, H3, Text } from '~/internals/development/sg/wildcard'

import { QueryExamples } from '../components/QueryExamples.tsx'

import { AnnotatedSearchInput } from './AnnotatedSearchExample.tsx'
