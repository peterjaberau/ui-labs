...
import { isSafari } from '~/internals/development/sg/common'
...
import { Icon, useWindowSize } from '~/internals/development/sg/wildcard'

import { decorateQuery } from '../../util/query.ts'

import { RenderAs, type Action, type Group, type Option } from './suggestionsExtension.ts'
import { getSpans } from './utils.ts'
