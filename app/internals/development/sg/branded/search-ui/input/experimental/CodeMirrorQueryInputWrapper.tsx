...
import { type Editor, useCompartment, viewToEditor } from '~/internals/development/sg/shared/components/CodeMirrorEditor.tsx'
...
import { QueryChangeSource, type QueryState } from '~/internals/development/sg/shared/search'
import { Button, Icon, Tooltip } from '~/internals/development/sg/wildcard'

import { BaseCodeMirrorQueryInput } from '../BaseCodeMirrorQueryInput.tsx'
import { queryDiagnostic } from '../codemirror/diagnostics.ts'
import { placeholder as placeholderExtension } from '../codemirror/placeholder.ts'
import { useUpdateInputFromQueryState } from '../codemirror/react.ts'
import { tokenInfo } from '../codemirror/token-info.ts'

import { overrideContextOnPaste } from './codemirror/searchcontext.ts'
import { filterDecoration } from './codemirror/syntax-highlighting.ts'
import { modeScope, useInputMode } from './modes.ts'
import { showWhenEmptyWithoutContext } from './placeholder.ts'
