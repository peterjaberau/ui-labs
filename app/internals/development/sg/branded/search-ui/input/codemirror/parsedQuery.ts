...
import { decorate, type DecoratedToken } from '~/internals/development/sg/shared/search/query/decoratedToken.ts'
import { type ParseResult, parseSearchQuery, type Node } from '~/internals/development/sg/shared/search/query/parser.ts'
import { detectPatternType, scanSearchQuery } from '~/internals/development/sg/shared/search/query/scanner.ts'
