...
import type { CodeMirrorQueryInputFacadeProps } from './CodeMirrorQueryInput.tsx'
...
const CodeMirrorQueryInput = lazyComponent(() => import('./CodeMirrorQueryInput.tsx'), 'CodeMirrorMonacoFacade')
