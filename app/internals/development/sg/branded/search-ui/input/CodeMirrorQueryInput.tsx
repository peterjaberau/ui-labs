...
import { useCompartment } from '~/internals/development/sg/shared/components/CodeMirrorEditor.tsx'
...
import { QueryChangeSource } from '~/internals/development/sg/shared/search'
import { appendContextFilter } from '~/internals/development/sg/shared/search/query/transformer.ts'
import { fetchStreamSuggestions as defaultFetchStreamSuggestions } from '~/internals/development/sg/shared/search/suggestions'
import type { RecentSearch } from '~/internals/development/sg/shared/settings/temporary/recentSearches.ts'
import { isInputElement } from '~/internals/development/sg/shared/util/dom.ts'

import { BaseCodeMirrorQueryInput, type BaseCodeMirrorQueryInputProps } from './BaseCodeMirrorQueryInput.tsx'
import { createDefaultSuggestions, placeholder as placeholderExtension } from './codemirror'
import { queryDiagnostic } from './codemirror/diagnostics.ts'
import { HISTORY_USER_EVENT, searchHistory as searchHistoryFacet } from './codemirror/history.ts'
import { useMutableValue, useOnValueChanged, useUpdateInputFromQueryState } from './codemirror/react.ts'
import { tokenInfo } from './codemirror/token-info.ts'
import { filterDecoration } from './experimental/codemirror/syntax-highlighting.ts'
import type { QueryInputProps } from './QueryInput.ts'
