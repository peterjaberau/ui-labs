...
import { createExtensionHostClientConnection } from '../api/client/connection.ts'
import type { InitData } from '../api/extension/extensionHost.ts'
import { syncPromiseSubscription } from '../api/util.ts'
