...
import type { PlatformContext, ClosableEndpointPair } from '../../platform/context.ts'
import { isSettingsValid } from '../../settings/settings.tsx'
import type { FlatExtensionHostAPI, MainThreadAPI } from '../contract.ts'
import type { ExtensionHostAPIFactory } from '../extension/api/api.ts'
import type { InitData } from '../extension/extensionHost.ts'
import { registerComlinkTransferHandlers } from '../util.ts'

import type { ClientAPI } from './api/api.ts'
import { type ExposedToClient, initMainThreadAPI } from './mainthread-api.ts'
