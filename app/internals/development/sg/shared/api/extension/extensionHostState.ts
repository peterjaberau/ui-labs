...
import type { Contributions } from '~/internals/development/sg/client-api'
...
import type { ExtensionViewer, ViewerUpdate } from '../viewerTypes.ts'

import { type ExecutableExtension, observeActiveExtensions } from './activation.ts'
import type { ExtensionCodeEditor } from './api/codeEditor.ts'
import type { ExtensionDocument } from './api/textDocument.ts'
import type { ExtensionWorkspaceRoot } from './api/workspaceRoot.ts'
import type { InitData } from './extensionHost.ts'
import type { RegisteredProvider } from './extensionHostApi.ts'
import { ReferenceCounter } from './utils/ReferenceCounter.ts'
