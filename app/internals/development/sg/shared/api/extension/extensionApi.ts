...
import { Location, MarkupKind, Position, Range, Selection } from '~/internals/development/sg/extension-api-classes'

import type { ClientAPI } from '../client/api/api.ts'
import { syncRemoteSubscription } from '../util.ts'

import { DocumentHighlightKind } from './api/documentHighlights.ts'
import { type InitData, updateContext } from './extensionHost.ts'
