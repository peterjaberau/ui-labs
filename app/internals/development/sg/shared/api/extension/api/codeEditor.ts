...
import { Selection } from '~/internals/development/sg/extension-api-classes'

import type { CodeEditorData, ViewerId } from '../../viewerTypes.ts'

import type { ExtensionDocument } from './textDocument.ts'
