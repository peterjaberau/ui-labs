...
import { Position, Range } from '~/internals/development/sg/extension-api-classes'

import type { TextDocument as PlainTextDocument } from '../../../codeintel/legacy-extensions/api.ts'

import { PrefixSumComputer } from './utils/prefixSumComputer.ts'
import { getWordAtText } from './utils/wordHelpers.ts'
