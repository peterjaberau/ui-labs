...
import type { ContributableMenu, Contributions, Evaluated, MenuItemContribution, Raw } from '~/internals/development/sg/client-api'
import { type Context, Expression, parse, parseTemplate } from '~/internals/development/sg/template-parser'
