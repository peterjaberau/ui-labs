...
import type { EndpointPair } from '../../platform/context.ts'
import type { SettingsCascade } from '../../settings/settings.tsx'
import type { ClientAPI } from '../client/api/api.ts'
import { registerComlinkTransferHandlers } from '../util.ts'

import { activateExtensions, replaceAPIRequire } from './activation.ts'
import type { ExtensionHostAPI, ExtensionHostAPIFactory } from './api/api.ts'
import { setActiveLoggers } from './api/logging.ts'
import { createExtensionAPIFactory } from './extensionApi.ts'
import { createExtensionHostAPI } from './extensionHostApi.ts'
import { createExtensionHostState, type ExtensionHostState } from './extensionHostState.ts'
