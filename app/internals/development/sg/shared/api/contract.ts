...
import type { GraphQLResult } from '~/internals/development/sg/http-client'

import type { DocumentHighlight, ReferenceContext } from '../codeintel/legacy-extensions/api.ts'
import type { Occurrence } from '../codeintel/scip.ts'
import type { ConfiguredExtension } from '../extensions/extension.ts'
import type { SettingsCascade } from '../settings/settings.tsx'
import type { TelemetryV2Props } from '../telemetry'

import type { SettingsEdit } from './client/services/settings.ts'
import type { ExecutableExtension } from './extension/activation.ts'
import type { ProxySubscribable } from './extension/api/common.ts'
import type { ContributionOptions } from './extension/extensionHostApi.ts'
import type { ExtensionViewer, TextDocumentData, ViewerData, ViewerId, ViewerUpdate } from './viewerTypes.ts'
