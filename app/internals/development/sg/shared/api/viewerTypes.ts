import type { Selection } from '~/internals/development/sg/extension-api-types'

import type { TextDocument } from '../codeintel/legacy-extensions/api.ts'

import type { ExtensionCodeEditor } from './extension/api/codeEditor.ts'
import type { ExtensionDirectoryViewer } from './extension/api/directoryViewer.ts'
