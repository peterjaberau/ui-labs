...
import type { DiffPart } from '~/internals/development/sg/codeintellify'
import { hasProperty } from '~/internals/development/sg/common'
import type { GraphQLClient, GraphQLResult } from '~/internals/development/sg/http-client'

import type { SettingsEdit } from '../api/client/services/settings.ts'
import type { ExecutableExtension } from '../api/extension/activation.ts'
import type { Scalars } from '../graphql-operations.ts'
import type { Settings, SettingsCascadeOrError } from '../settings/settings.tsx'
import type { TelemetryRecorder } from '../telemetry'
import type { TelemetryService } from '../telemetry/telemetryService.ts'
import type { FileSpec, UIPositionSpec, RawRepoSpec, RepoSpec, RevisionSpec, ViewStateSpec } from '../util/url.ts'
...
export interface PlatformContext {
     ...
     *
     * It is backed by a '@.../telemetry' implementation.
     */
