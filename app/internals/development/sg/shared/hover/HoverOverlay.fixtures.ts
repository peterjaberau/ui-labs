...
import type { MarkupContent, Badged, AggregableBadge } from '../codeintel/legacy-extensions/api.ts'
import { EMPTY_SETTINGS_CASCADE, type SettingsCascadeProps } from '../settings/settings.tsx'
import { noOpTelemetryRecorder } from '../telemetry'
import { NOOP_TELEMETRY_SERVICE } from '../telemetry/telemetryService.ts'

import type { HoverOverlayProps } from './HoverOverlay.tsx'
