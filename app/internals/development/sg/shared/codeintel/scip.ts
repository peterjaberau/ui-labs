...
import type * as extensions from '~/internals/development/sg/extension-api-types'

import { CodeGraphDataProvenance } from '../graphql-operations.ts'

import type * as sourcegraph from './legacy-extensions/api.ts'
