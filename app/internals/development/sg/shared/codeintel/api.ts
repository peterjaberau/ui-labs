...
import type { MaybeLoadingResult } from '~/internals/development/sg/codeintellify'
// eslint-disable-next-line no-restricted-imports
import { isDefined } from '~/internals/development/sg/common/types'
import type * as clientType from '~/internals/development/sg/extension-api-types'

import { match } from '../api/client/types/textDocument.ts'
import type { CodeIntelExtensionHostAPI, FlatExtensionHostAPI, ScipParameters } from '../api/contract.ts'
import { proxySubscribable } from '../api/extension/api/common.ts'
import { toPosition } from '../api/extension/api/types.ts'
import { getModeFromPath } from '../languages.ts'
import { parseRepoGitURI } from '../util/url.ts'

import type { DocumentSelector, TextDocument, DocumentHighlight } from './legacy-extensions/api.ts'
import * as sourcegraph from './legacy-extensions/api.ts'
import type { LanguageSpec } from './legacy-extensions/language-specs/language-spec.ts'
import { findLanguageSpec, languageSpecs } from './legacy-extensions/language-specs/languages.ts'
import { RedactingLogger } from './legacy-extensions/logging.ts'
import { createProviders, emptySourcegraphProviders, type SourcegraphProviders } from './legacy-extensions/providers.ts'
import { SymbolRole, Occurrence } from './scip.ts'
