import * as scip from '../../scip.ts'
import type * as sourcegraph from '../api.ts'
import type { Logger } from '../logging.ts'
import type { CombinedProviders, DefinitionAndHover } from '../providers.ts'
import { cache } from '../util.ts'
import { queryGraphQL as sgQueryGraphQL, type QueryGraphQLFn } from '../util/graphql.ts'
import { asyncGeneratorFromPromise } from '../util/ix.ts'
import { raceWithDelayOffset } from '../util/promise.ts'

import { definitionAndHoverForPosition, hoverPayloadToHover } from './definition-hover.ts'
import { filterLocationsForDocumentHighlights } from './highlights.ts'
import { implementationsForPosition } from './implementations.ts'
import { type RangeWindowFactoryFn, makeRangeWindowFactory } from './ranges.ts'
import { referencesForPosition, referencePageForPosition } from './references.ts'
import { makeStencilFn, type StencilFn } from './stencil.ts'
