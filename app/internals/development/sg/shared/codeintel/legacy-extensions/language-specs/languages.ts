...
import { cppSpec, cudaSpec } from './cpp.ts'
import { goSpec } from './go.ts'
import { createIdentCharPattern, rubyIdentCharPattern } from './identifiers.ts'
import { javaSpec } from './java.ts'
import type { LanguageSpec } from './language-spec.ts'
import { pythonSpec } from './python.ts'
import { typescriptSpec } from './typescript.ts'
