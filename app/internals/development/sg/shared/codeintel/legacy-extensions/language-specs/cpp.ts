import { cStyleComment } from './comments.ts'
import { type FilterContext, type LanguageSpec, type Result, LSIFSupport } from './language-spec.ts'
import { dotToSlash, extractFromLines, filterResultsByImports, removeExtension } from './util.ts'
