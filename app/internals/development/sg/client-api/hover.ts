...
import { MarkupKind, Range } from '~/internals/development/sg/extension-api-classes'
import type { Hover as PlainHover, Range as PlainRange } from '~/internals/development/sg/extension-api-types'
