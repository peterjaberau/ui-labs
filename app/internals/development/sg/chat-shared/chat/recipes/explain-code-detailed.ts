import { MAX_RECIPE_INPUT_TOKENS, MAX_RECIPE_SURROUNDING_TOKENS } from '../../prompt/constants.ts'
import { truncateText, truncateTextStart } from '../../prompt/truncation.ts'
import { Interaction } from '../transcript/interaction.ts'

import { getContextMessagesFromSelection, getNormalizedLanguageName, MARKDOWN_FORMAT_PROMPT } from './helpers.ts'
