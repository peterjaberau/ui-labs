...
import type { ContextMessage } from '../../codebase-context/messages.ts'
import type { ActiveTextEditorSelection } from '../../editor'
import { CHARS_PER_TOKEN, MAX_AVAILABLE_PROMPT_LENGTH, MAX_RECIPE_INPUT_TOKENS } from '../../prompt/constants.ts'
import { truncateText } from '../../prompt/truncation.ts'
import { getFileExtension, getNormalizedLanguageName } from '../recipes/helpers.ts'
import { Interaction } from '../transcript/interaction.ts'

import type { CodyPromptContext } from './index.ts'
import { prompts } from './templates.ts'
