...
import { getFileExtension, getNormalizedLanguageName } from '../chat/recipes/helpers.ts'
import type { ActiveTextEditorDiagnostic, ActiveTextEditorSelection } from '../editor'

import { MAX_RECIPE_INPUT_TOKENS } from './constants.ts'
import { truncateText, truncateTextStart } from './truncation.ts'
