...
import { Link, Icon, H2 } from '~/internals/development/sg/wildcard'

import { BrandLogo } from '../components/branding/BrandLogo.tsx'
import type { UserAreaUserProfileResult, UserAreaUserProfileVariables } from '../graphql-operations.ts'
import type { SourcegraphContext } from '../jscontext.ts'
import { USER_AREA_USER_PROFILE } from '../user/area/UserArea.tsx'

import { ExternalsAuth } from './components/ExternalsAuth.tsx'
