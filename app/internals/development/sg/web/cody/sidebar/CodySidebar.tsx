...
import { CodyLogo } from '~/internals/development/sg/chat-ui'
...
import { Alert, Button, H4, Icon, LoadingSpinner, ProductStatusBadge } from '~/internals/development/sg/wildcard'

import styles from './CodySidebar.module.scss'

const LazyCodySidebarWebChat = lazyComponent(() => import('./CodySidebarWebChat.tsx'), 'CodySidebarWebChat')
