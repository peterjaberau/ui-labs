...
import { Button, H1, H3, Icon, Modal, Text } from '~/internals/development/sg/wildcard'
...
import { humanizeDate, usdCentsToHumanString } from './utils.ts'
...
export const SubscriptionDetails: React.FC<SubscriptionDetailsProps> = props => {
    ...
    const errorMessage = updateCurrentSubscriptionMutation.isError
        ? 'An error occurred while updating your subscription status. Please try again. If the problem persists, contact support at support@domain.com.'
        : ''
