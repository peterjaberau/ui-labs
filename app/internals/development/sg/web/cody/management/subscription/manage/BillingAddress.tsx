...
import { useTheme, Theme } from '~/internals/development/sg/shared/theme.ts'
import { H3, Button, Text, Form } from '~/internals/development/sg/wildcard'

import { useUpdateCurrentSubscription } from '../../api/react-query/subscriptions.ts'
import type { Subscription } from '../../api/teamSubscriptions.ts'
import { BillingAddressPreview } from '../BillingAddressPreview.tsx'
import { StripeAddressElement } from '../StripeAddressElement.tsx'
...
const updateSubscriptionMutationErrorText =
    "We couldn't update your credit card info. Please try again. If this happens again, contact support at support@domain.com."
