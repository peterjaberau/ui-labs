import { Button, ButtonLink, H1, Text } from '~/internals/development/sg/wildcard'

import { CodyProRoutes } from '../codyProRoutes.tsx'
import { CodyAlert } from '../components/CodyAlert.tsx'
import { useAcceptInvite, useCancelInvite } from '../management/api/react-query/invites.ts'

import { useInviteParams } from './useInviteParams.ts'
import { UserInviteStatus, useInviteState } from './useInviteState.ts'
