...
import { H2, Link, Text, H3, TextArea, Button, H1 } from '~/internals/development/sg/wildcard'

import { CodyAlert } from '../components/CodyAlert.tsx'
import { CodyContainer } from '../components/CodyContainer.tsx'
import { CodyProBadgeDeck } from '../components/CodyProBadgeDeck.tsx'
import { useSendInvite, useTeamInvites } from '../management/api/react-query/invites.ts'
import { useCurrentSubscription, useUpdateCurrentSubscription } from '../management/api/react-query/subscriptions.ts'
import { useTeamMembers } from '../management/api/react-query/teams.ts'
import type { SubscriptionSummary } from '../management/api/teamSubscriptions.ts'
import { isValidEmailAddress } from '../util.ts'
            ...
            {sendInviteMutation.status === 'success' && (
                <CodyAlert variant="greenSuccess">
                    ...
                    <Text size="small" className="mb-0">
                        Invitees will receive an email from cody@domain.com.
                    </Text>
                </CodyAlert>
            )}
            ...
            <CodyContainer className="p-4 border bg-1 mb-4 d-flex flex-row">
                <div className="d-flex justify-content-between align-items-center w-100">
                    ...
                    <div className="flex-1 d-flex flex-column ml-4">
                        ...
                        <TextArea
                            className="mb-2"
                            placeholder="Example: someone@domain.com, another.user@domain.com"
                            rows={4}
                            onChange={event => {
