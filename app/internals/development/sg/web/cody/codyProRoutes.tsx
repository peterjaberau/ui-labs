...
import { QueryClientProvider } from './management/api/react-query/QueryClientProvider.tsx'
import { isEmbeddedCodyProUIEnabled } from './util.ts'
...
const routeComponents = {
    [CodyProRoutes.NewProSubscription]: lazyComponent(
        () => import('./management/subscription/new/NewCodyProSubscriptionPage.tsx'),
        'NewCodyProSubscriptionPage'
    ),
    [CodyProRoutes.Manage]: lazyComponent(() => import('./management/CodyManagementPage.tsx'), 'CodyManagementPage'),
    [CodyProRoutes.Subscription]: lazyComponent(
        () => import('./subscription/CodySubscriptionPage.tsx'),
        'CodySubscriptionPage'
    ),
    [CodyProRoutes.SubscriptionManage]: lazyComponent(
        () => import('./management/subscription/manage/CodySubscriptionManagePage.tsx'),
        'CodySubscriptionManagePage'
    ),
    [CodyProRoutes.ManageTeam]: lazyComponent(() => import('./team/CodyManageTeamPage.tsx'), 'CodyManageTeamPage'),
}
