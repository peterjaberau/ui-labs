...
import type {
    ...
    TranscriptJSON,
    TranscriptJSONScope,
} from '~/internals/development/sg/chat-shared'
import { NoopEditor, Transcript, useClient } from '~/internals/development/sg/chat-shared'
...
import { useCodyIgnore } from './useCodyIgnore.tsx'
import { currentUserRequiresEmailVerificationForCody } from './util.ts'
