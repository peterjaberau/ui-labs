...
import { CodeMirrorQueryInput, SyntaxHighlightedSearchQuery } from '~/internals/development/sg/branded'
import { pluralize } from '~/internals/development/sg/common'
import { createQueryExampleFromString, updateQueryWithFilterAndExample } from '~/internals/development/sg/shared/search'
import { FilterType } from '~/internals/development/sg/shared/search/query/filters.ts'
import type { PathMatch, SymbolMatch } from '~/internals/development/sg/shared/search/stream.ts'
import { Button, Label, useObservable } from '~/internals/development/sg/wildcard'

import type { BlockProps } from '../../index.ts'
import { SearchPatternType } from '../../../graphql-operations.ts'
import { blockKeymap, focusEditor } from '../../codemirror-utils.ts'
