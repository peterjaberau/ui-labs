...
import { CodeExcerpt } from '~/internals/development/sg/branded'
import { isErrorLike } from '~/internals/development/sg/common'
import { getRepositoryUrl } from '~/internals/development/sg/shared/search/stream.ts'
...
import { LoadingSpinner, useObservable, Icon, Alert } from '~/internals/development/sg/wildcard'

import type { BlockProps, FileBlock, FileBlockInput } from '../../index.ts'
import type { HighlightLineRange } from '../../../graphql-operations.ts'
import { focusEditor } from '../../codemirror-utils.ts'
import { parseFileBlockInput } from '../../serialize'
import type { BlockMenuAction } from '../menu/NotebookBlockMenu.tsx'
import { useCommonBlockMenuActions } from '../menu/useCommonBlockMenuActions.tsx'
import { NotebookBlock } from '../NotebookBlock.tsx'
import { RepoFileSymbolLink } from '../RepoFileSymbolLink.tsx'
import { useModifierKeyLabel } from '../useModifierKeyLabel.ts'

import { NotebookFileBlockInputs } from './NotebookFileBlockInputs.tsx'
