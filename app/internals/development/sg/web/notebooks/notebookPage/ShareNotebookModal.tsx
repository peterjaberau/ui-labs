...
import { Modal, Button, Checkbox, H3 } from '~/internals/development/sg/wildcard'

import type { AuthenticatedUser } from '../../auth.ts'

import { NotebookShareOptionsDropdown, type ShareOption } from './NotebookShareOptionsDropdown.tsx'
