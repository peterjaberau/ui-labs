...
import { BaseCodeMirrorQueryInput } from '~/internals/development/sg/branded/search-ui/input/BaseCodeMirrorQueryInput.tsx'
...
import { SearchJobsOrderBy, SearchJobState, SearchPatternType } from '~/internals/development/sg/shared/graphql-operations.ts'
import { detectPatternType } from '~/internals/development/sg/shared/search/query/scanner.ts'
...
import { DownloadFileButton } from '../../components/DownloadFileButton.tsx'
import { usePageSwitcherPagination } from '../../components/FilteredConnection/hooks/usePageSwitcherPagination.ts'
import { Page } from '../../components/Page.tsx'
import { PageTitle } from '../../components/PageTitle.tsx'
import { ListPageZeroState } from '../../components/ZeroStates/ListPageZeroState.tsx'
import type { SearchJobNode, SearchJobsResult, SearchJobsVariables } from '../../graphql-operations.ts'

import { SearchJobBadge } from './SearchJobBadge/SearchJobBadge.tsx'
import { CancelSearchJobModal, RerunSearchJobModal, SearchJobDeleteModal } from './SearchJobModal/SearchJobModal.tsx'
import { type User, UsersPicker } from './UsersPicker.tsx'
...
export const SearchJobsPage: FC<SearchJobsPageProps> = props => {
    ...
    return (
        <Page>
            ...
            <PageHeader
                annotation={<FeedbackBadge status="beta" feedback={{ mailto: 'support@domain.com' }} />}
