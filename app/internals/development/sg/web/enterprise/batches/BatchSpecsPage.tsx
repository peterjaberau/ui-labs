...
import { Container, PageHeader, H3, H5, Icon } from '~/internals/development/sg/wildcard'

import { FilteredConnection, type FilteredConnectionQueryArguments } from '../../components/FilteredConnection'
import { PageTitle } from '../../components/PageTitle.tsx'
import type { BatchSpecListFields, Scalars } from '../../graphql-operations.ts'

import {
    queryBatchSpecs as _queryBatchSpecs,
    queryBatchChangeBatchSpecs as _queryBatchChangeBatchSpecs,
} from './backend.ts'
import { BatchSpecNode, type BatchSpecNodeProps } from './BatchSpecNode.tsx'
