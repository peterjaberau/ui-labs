...
import type { Maybe } from '~/internals/development/sg/shared/graphql-operations.ts'
import { Button, Link, Alert, Icon, Tabs, TabList, TabPanels, TabPanel, Tab, H3, Tooltip } from '~/internals/development/sg/wildcard'

import { DiffStatStack } from '../../../../components/diff/DiffStat.tsx'
import { InputTooltip } from '../../../../components/InputTooltip.tsx'
import { ChangesetState, type VisibleChangesetApplyPreviewFields } from '../../../../graphql-operations.ts'
import { PersonLink } from '../../../../person/PersonLink.tsx'
import { Branch, BranchMerge } from '../../Branch.tsx'
import { Description } from '../../Description.tsx'
import { ChangesetStatusCell } from '../../detail/changesets/ChangesetStatusCell.tsx'
import { ExternalChangesetTitle } from '../../detail/changesets/ExternalChangesetTitle.tsx'
import type { PreviewPageAuthenticatedUser } from '../BatchChangePreviewPage.tsx'
import { checkPublishability } from '../utils.ts'

import type { queryChangesetSpecFileDiffs as _queryChangesetSpecFileDiffs } from './backend.ts'
import { ChangesetSpecFileDiffConnection } from './ChangesetSpecFileDiffConnection.tsx'
import { GitBranchChangesetDescriptionInfo } from './GitBranchChangesetDescriptionInfo.tsx'
import { PreviewActions } from './PreviewActions.tsx'
import { PreviewNodeIndicator } from './PreviewNodeIndicator.tsx'
