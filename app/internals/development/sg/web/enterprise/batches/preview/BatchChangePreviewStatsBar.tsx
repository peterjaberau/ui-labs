...
import { Badge, H2, H3, H4, useObservable } from '~/internals/development/sg/wildcard'

import { DiffStatStack } from '../../../components/diff/DiffStat.tsx'
import type { ApplyPreviewStatsFields, DiffStatFields, Scalars } from '../../../graphql-operations.ts'

import { queryApplyPreviewStats as _queryApplyPreviewStats } from './backend.ts'
import { BatchChangePreviewContext } from './BatchChangePreviewContext.tsx'
import { ChangesetAddedIcon, ChangesetModifiedIcon, ChangesetRemovedIcon } from './icons.tsx'
import {
    PreviewArchiveStat,
    PreviewCloseStat,
    PreviewImportStat,
