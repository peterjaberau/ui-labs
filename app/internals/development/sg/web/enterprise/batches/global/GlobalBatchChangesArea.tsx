...
import { canWriteBatchChanges, NO_ACCESS_BATCH_CHANGES_WRITE, NO_ACCESS_SOURCEGRAPH_COM } from '../../../batches/utils.ts'
import { NotFoundPage } from '../../../components/HeroPage.tsx'
import type { BatchChangeClosePageProps } from '../close/BatchChangeClosePage.tsx'
import type { CreateBatchChangePageProps } from '../create/CreateBatchChangePage.tsx'
import type { BatchChangeDetailsPageProps } from '../detail/BatchChangeDetailsPage.tsx'
import { TabName } from '../detail/BatchChangeDetailsTabs.tsx'
import type { BatchChangeListPageProps, NamespaceBatchChangeListPageProps } from '../list/BatchChangeListPage.tsx'
import type { BatchChangePreviewPageProps } from '../preview/BatchChangePreviewPage.tsx'

const BatchChangeListPage = lazyComponent<BatchChangeListPageProps, 'BatchChangeListPage'>(
    () => import('../list/BatchChangeListPage.tsx'),
    'BatchChangeListPage'
)
