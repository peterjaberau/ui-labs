...
import { Button, H3, Modal, Text } from '~/internals/development/sg/wildcard'
...
import type { ExecutorSecretAccessLogFields, Scalars } from '../../../graphql-operations.ts'
import { PersonLink } from '../../../person/PersonLink.tsx'

import { useExecutorSecretAccessLogsConnection } from './backend.ts'
