...
import { SettingsProvider } from '~/internals/development/sg/shared/settings/settings.tsx'
import { useTheme, Theme, ThemeSetting } from '~/internals/development/sg/shared/theme.ts'
...
import { OpenNewTabAnchorLink } from './OpenNewTabAnchorLink.tsx'
...
const EmbeddedNotebookPage = lazyComponent(
    () => import('../../notebooks/notebookPage/EmbeddedNotebookPage.tsx'),
