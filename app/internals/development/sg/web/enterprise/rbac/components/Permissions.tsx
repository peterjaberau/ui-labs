...
import { Text, Checkbox, Grid, Tooltip, Icon } from '~/internals/development/sg/wildcard'

import { BatchChangesReadPermission } from '../../../rbac/constants.ts'
import { prettifyAction, prettifyNamespace } from '../../../util/settings.ts'
import { type PermissionsMap, allNamespaces } from '../backend.ts'
