...
import { convertREMToPX } from '~/internals/development/sg/shared/components/utils/size.ts'
...
import type { RoleFields } from '../../../graphql-operations.ts'
import { prettifySystemRole } from '../../../util/settings.ts'
import { type PermissionsMap, useDeleteRole, useSetPermissions } from '../backend.ts'

import { ConfirmDeleteRoleModal } from './ConfirmDeleteRoleModal.tsx'
import { PermissionsList } from './Permissions.tsx'
