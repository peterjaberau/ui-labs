...
import { useLazyQuery } from '~/internals/development/sg/http-client'
import type { AuthenticatedUser } from '~/internals/development/sg/shared/auth.ts'
import { displayRepoName, RepoLink } from '~/internals/development/sg/shared/components/RepoLink.tsx'
...
import { DurationSelect, maxDuration } from '../components/DurationSelect.tsx'
import { FlashMessage } from '../components/FlashMessage.tsx'
import { RepositoryPatternList } from '../components/RepositoryPatternList.tsx'
import { nullPolicy } from '../hooks/types.tsx'
import { useDeletePolicies } from '../hooks/useDeletePolicies.tsx'
import { usePolicyConfigurationByID } from '../hooks/usePolicyConfigurationById.tsx'
import {
    convertGitObjectFilterResult,
    PREVIEW_GIT_OBJECT_FILTER,
    type GitObjectPreviewResult,
} from '../hooks/usePreviewGitObjectFilter.tsx'
import { useSavePolicyConfiguration } from '../hooks/useSavePolicyConfiguration.tsx'
import { hasGlobalPolicyViolation } from '../shared.ts'
