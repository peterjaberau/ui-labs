...
import type { CodeIntelRepositoryIndexConfigurationPageProps } from '../configuration/pages/CodeIntelRepositoryIndexConfigurationPage.tsx'
import type { RepoDashboardPageProps } from '../dashboard/pages/RepoDashboardPage.tsx'
...
import { CodeIntelSidebar, type CodeIntelSideBarGroups } from './CodeIntelSidebar.tsx'
...
const RepoDashboardPage = lazyComponent<RepoDashboardPageProps, 'RepoDashboardPage'>(
    () => import('../dashboard/pages/RepoDashboardPage.tsx'),
    'RepoDashboardPage'
)
...
>(
    () => import('../configuration/pages/CodeIntelRepositoryIndexConfigurationPage.tsx'),
    'CodeIntelRepositoryIndexConfigurationPage'
)
