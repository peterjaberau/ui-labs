...
import { Alert, BarChart, Card, ErrorAlert, Link, LoadingSpinner, Text } from '~/internals/development/sg/wildcard'
...
import { AnalyticsPageTitle } from '../../../site-admin/analytics/components/AnalyticsPageTitle.tsx'
import { ChartContainer } from '../../../site-admin/analytics/components/ChartContainer.tsx'

import { GET_INSTANCE_OWN_STATS, GET_OWN_JOB_CONFIGURATIONS } from './query.ts'
