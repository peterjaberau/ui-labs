...
import { LazyQueryInputFormControl } from '~/internals/development/sg/branded'
import type { QueryState } from '~/internals/development/sg/shared/search'
import { FilterType, resolveFilter, validateFilter } from '~/internals/development/sg/shared/search/query/filters.ts'
...
import { Button, Card, Checkbox, Code, H3, Icon, Link, Tooltip } from '~/internals/development/sg/wildcard'
    ...
    return (
        <>
            ...
            <small className="text-muted">
                ...
                <Link to="mailto:feedback@domain.com" target="_blank" rel="noopener">
                    Share feedback.
                </Link>
            </small>
        </>
