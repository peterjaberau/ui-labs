...
import { Alert, Input, Link, ProductStatusBadge, Label } from '~/internals/development/sg/wildcard'

import type { SendTestWebhookResult, SendTestWebhookVariables } from '../../../../graphql-operations.ts'
import type { ActionProps } from '../FormActionArea.tsx'
