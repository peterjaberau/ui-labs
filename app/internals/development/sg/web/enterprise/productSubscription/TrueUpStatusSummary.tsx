...
import { numberWithCommas } from '~/internals/development/sg/common'
import { Link } from '~/internals/development/sg/wildcard'

import { SingleValueCard } from '../../components/SingleValueCard.tsx'
    ...
    <div className="mb-2">
        <div className={styles.container}>
            ...
            <SingleValueCard
                ...
                subText="The true-up model has a retroactive charge for these users at the next renewal. If you want to update your license sooner to prevent this, please contact sales@domain.com."
                valueClassName={license.userCount - actualUserCount < 0 ? 'text-danger' : ''}
            />
        </div>
        <small>
            Learn more about{' '}
            <Link to="https://domain.com/pricing" target="_blank" rel="noopener noreferrer">
