...
import { dataOrThrowErrors, getDocumentNode, gql } from '~/internals/development/sg/http-client'
...
import { InsightType, type DashboardInsight, type InsightSuggestion } from './types.ts'
