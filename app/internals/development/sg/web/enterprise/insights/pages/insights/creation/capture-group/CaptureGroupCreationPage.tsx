...
import { CaptureGroupCreationContent } from './components/CaptureGroupCreationContent.tsx'
import { useCaptureInsightInitialValues } from './hooks/use-capture-insight-initial-values.ts'
import type { CaptureGroupFormFields } from './types.ts'
import { getSanitizedCaptureGroupInsight } from './utils/capture-group-insight-sanitizer.ts'
