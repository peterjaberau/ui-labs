...
import { Button, Modal, H2, Icon, ErrorAlert } from '~/internals/development/sg/wildcard'

import { LoaderButton } from '../../../../../../../components/LoaderButton.tsx'
import type { CustomInsightDashboard } from '../../../../../core/types'

import { useDeleteDashboardHandler } from './hooks/use-delete-dashboard-handler.ts'
