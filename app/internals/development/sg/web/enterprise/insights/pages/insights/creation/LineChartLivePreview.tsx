...
import { useDeepMemo, type Series, useDebounce, ErrorAlert } from '~/internals/development/sg/wildcard'
...
import { getSanitizedCaptureQuery } from './capture-group/utils/capture-group-insight-sanitizer.ts'
