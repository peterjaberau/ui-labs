...
import type { FormChangeEvent, SubmissionErrors } from '~/internals/development/sg/wildcard'
...
import { LineChartLivePreview, type LivePreviewSeries } from '../../LineChartLivePreview.tsx'
import type { CreateInsightFormFields } from '../types.ts'

import { type RenderPropertyInputs, SearchInsightCreationForm } from './SearchInsightCreationForm.tsx'
import { useInsightCreationForm } from './use-insight-creation-form.ts'
