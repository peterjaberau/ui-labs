...
import { useField, type FormChangeEvent, type SubmissionErrors, useForm } from '~/internals/development/sg/wildcard'

import { CreationUiLayout, CreationUIForm, CreationUIPreview, useRepoFields } from '../../../../../components'
import { LineChartLivePreview } from '../../LineChartLivePreview.tsx'
import type { CaptureGroupFormFields } from '../types.ts'

import { CaptureGroupCreationForm, type RenderPropertyInputs } from './CaptureGoupCreationForm.tsx'
import { QUERY_VALIDATORS, STEP_VALIDATORS, TITLE_VALIDATORS } from './validators.ts'
