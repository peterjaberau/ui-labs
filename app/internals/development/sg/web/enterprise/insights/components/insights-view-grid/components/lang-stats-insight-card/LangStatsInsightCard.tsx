...
import { Link, ParentSize, ErrorAlert } from '~/internals/development/sg/wildcard'

import type { LangStatsInsight } from '../../../../core'
import { useLazyLivePreviewLangStatsInsight } from '../../../../core/hooks/live-preview-insight'
import { LazyQueryStatus } from '../../../../hooks/use-parallel-requests/use-parallel-request.ts'
...
import { useInsightData } from '../../hooks/use-insight-data.ts'
