...
import { Link, useDebounce, useDeepMemo, Text } from '~/internals/development/sg/wildcard'

import type { GetInsightViewResult, GetInsightViewVariables } from '../../../../../../graphql-operations.ts'
...
import { useVisibility } from '../../hooks/use-insight-data.ts'
import { InsightContextMenu } from '../insight-context-menu/InsightContextMenu.tsx'
import { InsightContext } from '../InsightContext.ts'
