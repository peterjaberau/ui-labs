import { createRequiredValidator, composeValidators, type ValidationResult } from '~/internals/development/sg/wildcard'

import { searchQueryValidator } from '../../../../../pages/insights/creation/capture-group/utils/search-query-validator.ts'
