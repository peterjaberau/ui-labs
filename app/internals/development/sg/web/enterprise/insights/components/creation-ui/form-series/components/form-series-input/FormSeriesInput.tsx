...
import { findFilter, FilterKind } from '~/internals/development/sg/shared/search/query/query.ts'
import { useSettingsCascade } from '~/internals/development/sg/shared/settings/settings.tsx'
import { Button, Card, Input, Code, useForm, useField, getDefaultInputProps } from '~/internals/development/sg/wildcard'

import { defaultPatternTypeFromSettings } from '../../../../../../../util/settings.ts'
import { DEFAULT_DATA_SERIES_COLOR } from '../../../../../constants.ts'
import { InsightQueryInput } from '../../../../form'
import type { EditableDataSeries } from '../../types.ts'
import { FormColorInput } from '../form-color-input/FormColorInput.tsx'

import { getQueryPatternTypeFilter } from './get-pattern-type-filter.ts'
import { SERIES_NAME_VALIDATORS, SERIES_QUERY_VALIDATORS } from './validators.ts'
