...
import type { InsightUpdateInput } from '../../../code-insights-backend-types.ts'
import { UPDATE_LANG_STATS_INSIGHT_GQL } from '../../gql/UpdateLangStatsInsight.ts'
import { UPDATE_LINE_CHART_SEARCH_INSIGHT_GQL } from '../../gql/UpdateLineChartSearchInsight.ts'
