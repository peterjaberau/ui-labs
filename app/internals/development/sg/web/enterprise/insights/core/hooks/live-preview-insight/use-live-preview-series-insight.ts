...
import type { Series } from '~/internals/development/sg/wildcard'
...
import { DATA_SERIES_COLORS_LIST, MAX_NUMBER_OF_SERIES } from '../../../constants.ts'
import { getStepInterval } from '../../backend/gql-backend/utils/get-step-interval.ts'
import { generateLinkURL, type InsightDataSeriesData } from '../../backend/utils/create-line-chart-content.ts'

import { LivePreviewStatus, type State } from './types.ts'
