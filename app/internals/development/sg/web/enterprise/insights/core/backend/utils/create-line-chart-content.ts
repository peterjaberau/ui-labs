...
import { type InsightDataSeries, SearchPatternType } from '../../../../../graphql-operations.ts'
import { PageRoutes } from '../../../../../routes.constants.ts'
import type { BackendInsight, SearchBasedInsightSeries } from '../../types'
import type { BackendInsightDatum, BackendInsightSeries } from '../code-insights-backend-types.ts'

import { getParsedSeriesMetadata } from './parse-series-metadata.ts'
