...
import type { SaveInsightAsNewViewResult, SaveInsightAsNewViewVariables } from '../../../../graphql-operations.ts'
import { INSIGHT_VIEW_FRAGMENT } from '../backend/gql-backend/gql/GetInsights.ts'
import { searchInsightCreationOptimisticUpdate } from '../backend/gql-backend/methods/create-insight/create-insight.ts'
