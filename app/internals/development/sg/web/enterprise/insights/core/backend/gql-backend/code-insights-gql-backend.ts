...
import { fromObservableQuery } from '~/internals/development/sg/http-client'
...
import type { CodeInsightsBackend } from '../code-insights-backend.ts'
import type {
...
} from '../code-insights-backend-types.ts'

import { createInsightView } from './deserialization/create-insight-view.ts'
import { GET_DASHBOARD_INSIGHTS_GQL } from './gql/GetDashboardInsights.ts'
import { GET_INSIGHTS_GQL } from './gql/GetInsights.ts'
import { REMOVE_INSIGHT_FROM_DASHBOARD_GQL } from './gql/RemoveInsightFromDashboard.ts'
import { createDashboard } from './methods/create-dashboard/create-dashboard.ts'
import { createInsight } from './methods/create-insight/create-insight.ts'
import { getDashboardOwners } from './methods/get-dashboard-owners.ts'
import { updateDashboard } from './methods/update-dashboard.ts'
import { updateInsight } from './methods/update-insight/update-insight.ts'
