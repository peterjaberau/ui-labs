...
import { Route, Routes, Navigate } from '@remix-run/react'
...
import type { GetFirstAvailableDashboardResult, GetFirstAvailableDashboardVariables } from '../../graphql-operations.ts'

import { CodeInsightsBackendContext } from './core'
import { useApi } from './hooks'
import { useLicense } from './hooks/use-license.ts'
import { GaConfirmationModal } from './modals/GaConfirmationModal.tsx'
import { CodeInsightsRootPage, CodeInsightsRootPageTab } from './pages/CodeInsightsRootPage.tsx'
import { InsightsDashboardCreationPage } from './pages/dashboards/creation/InsightsDashboardCreationPage.tsx'
import { EditDashboardPage } from './pages/dashboards/edit-dashboard/EditDashobardPage.tsx'
import { CreationRoutes } from './pages/insights/creation/CreationRoutes.tsx'
import { CodeInsightIndependentPage } from './pages/insights/insight/CodeInsightIndependentPage.tsx'

const EditInsightLazyPage = lazyComponent(
    () => import('./pages/insights/edit-insight/EditInsightPage.tsx'),
    'EditInsightPage'
)
