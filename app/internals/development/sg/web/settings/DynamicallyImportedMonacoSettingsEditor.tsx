...
import { LoadingSpinner, BeforeUnloadPrompt } from '~/internals/development/sg/wildcard'

import { type SaveToolbarProps, SaveToolbar, type SaveToolbarPropsGenerator } from '../components/SaveToolbar.tsx'

import { type EditorAction, EditorActionsGroup } from './EditorActionsGroup.tsx'
import type * as _monacoSettingsEditorModule from './MonacoSettingsEditor.tsx'
...
const MonacoSettingsEditor = React.lazy(async () => ({
    default: (await import('./MonacoSettingsEditor.tsx')).MonacoSettingsEditor,
}))
            ...
            this.subscriptions.add(
                disposableToFunc(
                    this.monaco.editor.onDidCreateModel(async model => {
                        ...
                        const { MonacoSettingsEditor } = await import('./MonacoSettingsEditor.tsx')
