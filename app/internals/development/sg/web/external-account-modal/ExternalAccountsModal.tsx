...
import { useTemporarySetting } from '~/internals/development/sg/shared/settings/temporary'
import type { SeenAuthProvider } from '~/internals/development/sg/shared/settings/temporary/TemporarySettings.ts'
import type { TelemetryV2Props } from '~/internals/development/sg/shared/telemetry'
import { Button, ErrorAlert, H2, LoadingSpinner, Modal, Text } from '~/internals/development/sg/wildcard'

import type { AuthenticatedUser } from '../auth.ts'
import { BrandLogo } from '../components/branding/BrandLogo.tsx'
import type { UserExternalAccountsWithAccountDataVariables } from '../graphql-operations.ts'
import type { AuthProvider, SourcegraphContext } from '../jscontext.ts'
import { ExternalAccountsSignIn } from '../user/settings/auth/ExternalAccountsSignIn.tsx'
import type { UserExternalAccount, UserExternalAccountsResult } from '../user/settings/auth/UserSettingsSecurityPage.tsx'
