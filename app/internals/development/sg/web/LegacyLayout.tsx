...
import { matchPath, Navigate, Route, Routes, useLocation, type RouteObject } from '@remix-run/react'
...
import { Theme, useTheme } from '~/internals/development/sg/shared/theme.ts'
import { lazyComponent } from '~/internals/development/sg/shared/util/lazyComponent.tsx'
import { FeedbackPrompt, LoadingSpinner, useLocalStorage } from '~/internals/development/sg/wildcard'
...
import { LazyFuzzyFinder } from './components/fuzzyFinder/LazyFuzzyFinder.tsx'
import { KeyboardShortcutsHelp } from './components/KeyboardShortcutsHelp/KeyboardShortcutsHelp.tsx'
import { useScrollToLocationHash } from './components/useScrollToLocationHash.ts'
import { useUserHistory } from './components/useUserHistory.ts'
import { GlobalContributions } from './contributions.ts'
import { ExternalAccountsModal } from './external-account-modal/ExternalAccountsModal.tsx'
import { useFeatureFlag } from './featureFlags/useFeatureFlag.ts'
import { GlobalAlerts } from './global/GlobalAlerts.tsx'
import { useHandleSubmitFeedback } from './hooks'
import type { LegacyLayoutRouteContext } from './LegacyRouteContext.tsx'
import { SurveyToast } from './marketing/toast'
import { GlobalNavbar } from './nav/GlobalNavbar.tsx'
...
import { SearchQueryStateObserver } from './SearchQueryStateObserver.tsx'
import { isSourcegraphDev, useDeveloperSettings } from './stores'
import { isAccessTokenCallbackPage } from './user/settings/accessTokens/UserSettingsCreateAccessTokenCallbackPage.tsx'

import styles from './storm/pages/LayoutPage/LayoutPage.module.scss'

const LazySetupWizard = lazyComponent(() => import('./setup-wizard/SetupWizard.tsx'), 'SetupWizard')
const LazyDeveloperDialog = lazyComponent(() => import('./devsettings/DeveloperDialog.tsx'), 'DeveloperDialog')
