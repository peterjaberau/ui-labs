...
import { logger } from '~/internals/development/sg/common/src/util/logger'
import { useMutation, useQuery } from '~/internals/development/sg/http-client'
import { ErrorAlert, Text, H3, LoadingSpinner, PageHeader, Input, Container } from '~/internals/development/sg/wildcard'

import { LoaderButton } from '../../../components/LoaderButton.tsx'
import { PageTitle } from '../../../components/PageTitle.tsx'
import type { Scalars } from '../../../graphql-operations.ts'

import { SET_USER_CODE_COMPLETIONS_QUOTA, SET_USER_COMPLETIONS_QUOTA, USER_REQUEST_QUOTAS } from './backend.ts'
