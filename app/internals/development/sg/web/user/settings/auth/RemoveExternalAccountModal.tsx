...
import { asError, type ErrorLike } from '~/internals/development/sg/common'
import { gql, dataOrThrowErrors } from '~/internals/development/sg/http-client'
import { Button, Modal, H3, Form } from '~/internals/development/sg/wildcard'

import { requestGraphQL } from '../../../backend/graphql.ts'
import type { Scalars, DeleteExternalAccountResult, DeleteExternalAccountVariables } from '../../../graphql-operations.ts'
