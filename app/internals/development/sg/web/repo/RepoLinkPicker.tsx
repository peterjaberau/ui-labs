...
import { useQuery, gql } from '~/internals/development/sg/http-client'
...
import type { RepositoriesSuggestionsResult, RepositoriesSuggestionsVariables } from '../graphql-operations.ts'

import { CodeHostType } from './constants.ts'
import { getInitialSearchTerm, stringToCodeHostType } from './utils.tsx'
