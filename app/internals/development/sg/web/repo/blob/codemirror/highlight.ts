...
import { Occurrence, SyntaxKind } from '~/internals/development/sg/shared/codeintel/scip.ts'

import { OccurrenceIndex } from './codeintel/occurrences.ts'
import { positionToOffset } from './utils.ts'
