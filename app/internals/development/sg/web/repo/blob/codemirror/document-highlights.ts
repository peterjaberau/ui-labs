...
import type { DocumentHighlight } from '~/internals/development/sg/codeintellify'
import type { Position } from '~/internals/development/sg/extension-api-types'
import { createUpdateableField } from '~/internals/development/sg/shared/components/codemirror/utils.ts'
import type { UIPositionSpec } from '~/internals/development/sg/shared/util/url.ts'

import { offsetToUIPosition, positionToOffset, preciseWordAtCoords, sortRangeValuesByStart } from './utils.ts'
