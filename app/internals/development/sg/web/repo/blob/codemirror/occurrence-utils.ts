...
import { Occurrence, Position, Range as ScipRange, SyntaxKind } from '~/internals/development/sg/shared/codeintel/scip.ts'

import { codeGraphData } from './codeintel/occurrences.ts'
