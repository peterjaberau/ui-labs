...
import { type LineOrPositionOrRange, isErrorLike } from '~/internals/development/sg/common'

import { WebHoverOverlay, type WebHoverOverlayProps } from '../../../../components/WebHoverOverlay'
import type { BlobPropsFacet } from '../../CodeMirrorBlob.tsx'
import type { TooltipViewOptions } from '../codeintel/api.ts'
import { pinConfig, pinnedLocation } from '../codeintel/pin.ts'
import { blobPropsFacet } from '../index.ts'
import { CodeMirrorContainer } from '../react-interop.tsx'
import { zeroToOneBasedPosition } from '../utils.ts'
