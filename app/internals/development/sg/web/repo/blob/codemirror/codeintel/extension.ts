...
import { uiPositionToOffset } from '../utils.ts'

import { CodeIntelAPIAdapter, type CodeIntelAPIConfig, codeIntelAPIAdapter, findOccurrenceRangeAt } from './api.ts'
import { goToDefinitionOnClick } from './definition.ts'
import { hoverExtension } from './hover.ts'
import { keyboardShortcutsExtension } from './keybindings.ts'
import { isModifierKeyHeld } from './modifier-key.ts'
import { type PinConfig, pinConfig, pinnedLocation, pinnedRange } from './pin.ts'
import { selectedTokenExtension } from './token-selection.ts'
...
const tooltipStyles = EditorView.theme({
    // Tooltip styles is a combination of the default wildcard PopoverContent component (https://github.com/sourcegraph/sourcegraph/blob/5de30f6fa1c59d66341e4dfc0c374cab0ad17bff/client/~/sg/wildcard/components/Popover/components/popover-content/PopoverContent.module.scss#L1-L10)
    // and the floating tooltip-like storybook usage example (https://github.com/sourcegraph/sourcegraph/blob/5de30f6fa1c59d66341e4dfc0c374cab0ad17bff/client/~/sg/wildcard/components/Popover/story/Popover.story.module.scss#L54-L62)
