...
import { isMacPlatform } from '~/internals/development/sg/common'
import { MarkupKind } from '~/internals/development/sg/extension-api-classes'
import type { Range } from '~/internals/development/sg/extension-api-types'
import type { ActionItemAction } from '~/internals/development/sg/shared/actions/ActionItem.tsx'
import {
    type CodeIntelAPI,
    findLanguageMatchingDocument,
    hasFindImplementationsSupport,
} from '~/internals/development/sg/shared/codeintel/api.ts'
import type { Occurrence } from '~/internals/development/sg/shared/codeintel/scip.ts'
import { makeRepoGitURI, parseRepoGitURI } from '~/internals/development/sg/shared/util/url.ts'
import type { UIRangeSpec } from '~/internals/development/sg/shared/util/url.ts'

import type { WebHoverOverlayProps } from '../../../../components/WebHoverOverlay'
import { syntaxHighlight } from '../highlight.ts'
import { contains, interactiveOccurrenceAt, positionAtCmPosition, rangeToCmSelection } from '../occurrence-utils.ts'
import { isRegularEvent, locationToURL, positionToOffset } from '../utils.ts'

import { codeGraphData } from './occurrences.ts'
