...
import { TabbedPanelContent } from '~/internals/development/sg/branded/components/panel/TabbedPanelContent.tsx'
import { NoopEditor } from '~/internals/development/sg/chat-shared'
import { asError, basename, isErrorLike, SourcegraphURL, type ErrorLike } from '~/internals/development/sg/common'
import {
    createActiveSpan,
    reactManualTracer,
    TraceSpanProvider,
    useCurrentSpan,
} from '~/internals/development/sg/observability-client'
import type { FetchFileParameters } from '~/internals/development/sg/shared/backend/file.ts'
import { HighlightResponseFormat, SearchPatternType } from '~/internals/development/sg/shared/graphql-operations.ts'
...
import { useExperimentalFeatures, type SettingsCascadeProps } from '~/internals/development/sg/shared/settings/settings.tsx'
...
import { type ModeSpec, type RepoFile } from '~/internals/development/sg/shared/util/url.ts'
import {
    Alert,
    Button,
    ButtonLink,
...
import { FileContentEditor } from '../../cody/components/FileContentEditor.ts'
...
import { OpenInEditorActionItem } from '../../open-in-editor/OpenInEditorActionItem.tsx'
import { ToggleOpenCodeGraphVisibilityAction } from '../../opencodegraph/global/ToggleOpenCodeGraphVisibility.tsx'
import { useOpenCodeGraphVisibility } from '../../opencodegraph/global/useOpenCodeGraphVisibility.ts'
import type { OwnConfigProps } from '../../own/OwnConfigProps.ts'
import type { SearchStreamingProps } from '../../search'
import { parseBrowserRepoURL, toTreeURL } from '../../util/url.ts'
import { serviceKindDisplayNameAndIcon } from '../actions/GoToCodeHostAction.tsx'
import { ToggleBlameAction } from '../actions/ToggleBlameAction.tsx'
import { useBlameHunks, useBlameVisibility } from '../blame/hooks.ts'
...
import { GoToRawAction } from './actions/GoToRawAction.tsx'
import { ToggleHistoryPanel } from './actions/ToggleHistoryPanel.tsx'
import { ToggleLineWrap } from './actions/ToggleLineWrap.tsx'
import { ToggleRenderedFileMode } from './actions/ToggleRenderedFileMode.tsx'
import { getModeFromURL } from './actions/utils.ts'
import { fetchBlob } from './backend.ts'
import { BlobLoadingSpinner } from './BlobLoadingSpinner.tsx'
import { CodeMirrorBlob, type BlobInfo } from './CodeMirrorBlob.tsx'
import { HistoryAndOwnBar } from './own/HistoryAndOwnBar.tsx'
import { BlobPanel } from './panel/BlobPanel.tsx'
import { RenderedFile } from './RenderedFile.tsx'
...
const RenderedNotebookMarkdown = lazyComponent(() => import('./RenderedNotebookMarkdown.tsx'), 'RenderedNotebookMarkdown')
