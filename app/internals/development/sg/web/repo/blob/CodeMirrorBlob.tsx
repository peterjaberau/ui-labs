...
import { createPath, useLocation, useNavigate, type Location, type NavigateFunction } from '@remix-run/react'

import { NoopEditor } from '~/internals/development/sg/chat-shared'
import { SourcegraphURL } from '~/internals/development/sg/common'
import { createCodeIntelAPI } from '~/internals/development/sg/shared/codeintel/api.ts'
import { editorHeight, useCodeMirror, useCompartment } from '~/internals/development/sg/shared/components/CodeMirrorEditor.tsx'
import { useKeyboardShortcut } from '~/internals/development/sg/shared/keyboardShortcuts/useKeyboardShortcut.ts'
import { Shortcut } from '~/internals/development/sg/shared/react-shortcuts'
import { useSettings } from '~/internals/development/sg/shared/settings/settings.tsx'
import type { TemporarySettingsSchema } from '~/internals/development/sg/shared/settings/temporary/TemporarySettings.ts'
...
import { codeCopiedEvent } from '~/internals/development/sg/shared/tracking/event-log-creators.ts'
import {
    toPrettyBlobURL,
    type AbsoluteRepoFile,
    type BlobViewState,
    type ModeSpec,
} from '~/internals/development/sg/shared/util/url.ts'
import { useLocalStorage } from '~/internals/development/sg/wildcard'

import { CodeMirrorEditor } from '../../cody/components/CodeMirrorEditor.ts'
import { useCodySidebar } from '../../cody/sidebar/Provider.tsx'
import { useFeatureFlag } from '../../featureFlags/useFeatureFlag.ts'
import type { ExternalLinkFields, Scalars } from '../../graphql-operations.ts'
import { requestGraphQLAdapter } from '../../platform/context.ts'
import type { BlameHunkData } from '../blame/shared.ts'
import type { HoverThresholdProps } from '../RepoContainer.tsx'

import { BlameDecoration } from './BlameDecoration.tsx'
import { blobPropsFacet } from './codemirror'
import { blameData, showBlame } from './codemirror/blame-decorations.ts'
import { codeFoldingExtension } from './codemirror/code-folding.tsx'
import { createCodeIntelExtension } from './codemirror/codeintel/extension.ts'
import { pinnedLocation } from './codemirror/codeintel/pin.ts'
import { syncSelection } from './codemirror/codeintel/token-selection.ts'
import { hideEmptyLastLine } from './codemirror/eof.ts'
import { syntaxHighlight } from './codemirror/highlight.ts'
import { selectableLineNumbers, selectLines, type SelectedLineRange } from './codemirror/linenumbers.ts'
import { linkify } from './codemirror/links.ts'
import { lockFirstVisibleLine } from './codemirror/lock-line.ts'
import { navigateToLineOnAnyClickExtension } from './codemirror/navigate-to-any-line-on-click.ts'
import { CodeMirrorContainer } from './codemirror/react-interop.tsx'
import { scipSnapshot } from './codemirror/scip-snapshot.ts'
import { search, type SearchPanelConfig } from './codemirror/search.ts'
import { SearchPanel } from './codemirror/search/SearchPanel.tsx'
import { staticHighlights, type Range } from './codemirror/static-highlights.tsx'
import { HovercardView } from './codemirror/tooltips/HovercardView.tsx'
import { showTemporaryTooltip, temporaryTooltip } from './codemirror/tooltips/TemporaryTooltip.ts'
import { locationToURL, positionToOffset } from './codemirror/utils.ts'
import { setBlobEditView } from './use-blob-store.ts'
