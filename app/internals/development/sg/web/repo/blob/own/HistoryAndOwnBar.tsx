...
import { logger, pluralize } from '~/internals/development/sg/common'
...
import { Alert, Button, Icon, LoadingSpinner, Tooltip } from '~/internals/development/sg/wildcard'

import type { FetchOwnersAndHistoryResult, FetchOwnersAndHistoryVariables } from '../../../graphql-operations.ts'
import { formatPersonName } from '../../../person/PersonLink.tsx'
import { GitCommitNode } from '../../commits/GitCommitNode.tsx'

import { FETCH_OWNERS_AND_HISTORY } from './grapqlQueries.ts'
