...
import { useLocalStorage, useObservable } from '~/internals/development/sg/wildcard'

import { requestGraphQL } from '../../backend/graphql.ts'
import type { ExternalRepoURLsResult, ExternalRepoURLsVariables } from '../../graphql-operations.ts'

import { BlameHunkData, fetchBlameHunksMemoized } from './shared.ts'
