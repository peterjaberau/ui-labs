...
import { Link, flattenTree, type TreeNode } from '~/internals/development/sg/wildcard'

import { type SymbolNodeFields, SymbolKind as SymbolKindEnum } from '../graphql-operations.ts'
...
import type { SymbolPlaceholder, SymbolWithChildren } from './RepoRevisionSidebarSymbols.tsx'
