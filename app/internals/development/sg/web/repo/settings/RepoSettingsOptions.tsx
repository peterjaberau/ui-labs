...
import { useMutation, useQuery } from '~/internals/development/sg/http-client'
import { EVENT_LOGGER } from '~/internals/development/sg/shared/telemetry/web/eventLogger.ts'
import { Button, Container, ErrorAlert, H3, LoadingSpinner, renderError, Text } from '~/internals/development/sg/wildcard'
...
import { SITE_EXTERNAL_SERVICE_CONFIG } from '../../site-admin/backend.ts'

import { EXCLUDE_REPO_FROM_EXTERNAL_SERVICES, FETCH_SETTINGS_AREA_REPOSITORY_GQL } from './backend.ts'
import { ExternalServiceEntry } from './components/ExternalServiceEntry.tsx'
import { RedirectionAlert } from './components/RedirectionAlert.tsx'
