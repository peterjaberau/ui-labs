...
import { Route, Routes, useLocation, type Location } from '@remix-run/react'
import { NEVER, of } from 'rxjs'
import { catchError, switchMap } from 'rxjs/operators'

import type { StreamingSearchResultsListProps } from '~/internals/development/sg/branded'
import { asError, isErrorLike, repeatUntil, type ErrorLike } from '~/internals/development/sg/common'
import {
...
import { EditorHint, type SearchContextProps } from '~/internals/development/sg/shared/search'
import { escapeSpaces } from '~/internals/development/sg/shared/search/query/filters.ts'
...
import { LoadingSpinner, Panel, useObservable } from '~/internals/development/sg/wildcard'

import type { AuthenticatedUser } from '../auth.ts'
import type { BatchChangesProps } from '../batches'
import type { CodeIntelligenceProps } from '../codeintel'
import { RepoContainerEditor } from '../cody/components/RepoContainerEditor.ts'
import { CodySidebar } from '../cody/sidebar'
import { CODY_SIDEBAR_SIZES, useCodySidebar, useSidebarSize } from '../cody/sidebar/Provider.tsx'
import { useCodyIgnore } from '../cody/useCodyIgnore.tsx'
...
import type { ExternalLinkFields, RepositoryFields } from '../graphql-operations.ts'
...
import { GoToCodeHostAction } from './actions/GoToCodeHostAction.tsx'
import { fetchFileExternalLinks, resolveRepoRevision, type Repo, type ResolvedRevision } from './backend.ts'
import { AskCodyButton } from './cody/AskCodyButton.tsx'
import { RepoContainerError } from './RepoContainerError.tsx'
import { RepoHeader, type RepoHeaderContributionsLifecycleProps } from './RepoHeader.tsx'
import { RepoHeaderContributionPortal } from './RepoHeaderContributionPortal.tsx'
import { RepoLinkPicker } from './RepoLinkPicker.tsx'
import {
    RepoRevisionContainer,
    type RepoRevisionContainerContext,
    type RepoRevisionContainerRoute,
} from './RepoRevisionContainer.tsx'
...
import { repoSettingsAreaPath } from './settings/routes.tsx'

import styles from './RepoContainer.module.scss'

const RepoSettingsArea = lazyComponent(() => import('./settings/RepoSettingsArea.tsx'), 'RepoSettingsArea')
