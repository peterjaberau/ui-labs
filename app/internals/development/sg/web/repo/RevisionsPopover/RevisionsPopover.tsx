...
import { GitRefType, type Scalars } from '~/internals/development/sg/shared/graphql-operations.ts'
...
import { Button, useLocalStorage, Tab, TabList, TabPanel, TabPanels, Icon } from '~/internals/development/sg/wildcard'

import type { GitCommitAncestorFields, GitRefFields } from '../../graphql-operations.ts'
import { replaceRevisionInURL } from '../../util/url.ts'
import { isPackageServiceType } from '../packages/isPackageServiceType.ts'

import { ConnectionPopoverTabs } from './components'
import { RevisionsPopoverCommits } from './RevisionsPopoverCommits.tsx'
import { RevisionsPopoverReferences } from './RevisionsPopoverReferences.tsx'
