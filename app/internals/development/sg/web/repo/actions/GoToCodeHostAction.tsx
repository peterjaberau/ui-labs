...
import { asError, type ErrorLike, isErrorLike, logger } from '~/internals/development/sg/common'
import type { Position, Range } from '~/internals/development/sg/extension-api-types'
import { SimpleActionItem } from '~/internals/development/sg/shared/actions/SimpleActionItem.tsx'
// TODO: Switch mdi icon
import { HelixSwarmIcon, PhabricatorIcon } from '~/internals/development/sg/shared/components/icons.tsx'
...
import type { FileSpec, RevisionSpec } from '~/internals/development/sg/shared/util/url.ts'
import { type ButtonLinkProps, Icon, Link, Tooltip, useObservable } from '~/internals/development/sg/wildcard'

import { type ExternalLinkFields, ExternalServiceKind, type RepositoryFields } from '../../graphql-operations.ts'
import { fetchCommitMessage, fetchFileExternalLinks } from '../backend.ts'
