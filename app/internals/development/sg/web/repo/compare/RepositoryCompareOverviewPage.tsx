...
import { asError, createAggregateError, type ErrorLike, isErrorLike, logger } from '~/internals/development/sg/common'
import { gql } from '~/internals/development/sg/http-client'
import { TelemetryRecorder } from '~/internals/development/sg/shared/telemetry'
import { EVENT_LOGGER } from '~/internals/development/sg/shared/telemetry/web/eventLogger.ts'
import { LoadingSpinner, Text, ErrorAlert } from '~/internals/development/sg/wildcard'

import { queryGraphQL } from '../../backend/graphql.ts'
import { PageTitle } from '../../components/PageTitle.tsx'
import type { RepositoryComparisonFields, RepositoryComparisonResult, Scalars } from '../../graphql-operations.ts'

import type { RepositoryCompareAreaPageProps } from './RepositoryCompareArea.tsx'
import { RepositoryCompareCommitsPage } from './RepositoryCompareCommitsPage.tsx'
import { RepositoryCompareDiffPage } from './RepositoryCompareDiffPage.tsx'
