...
import { TourIcon, type TourTaskType } from '~/internals/development/sg/shared/settings/temporary'

import type { OnboardingTourConfigResult, OnboardingTourConfigVariables } from '../../graphql-operations.ts'
