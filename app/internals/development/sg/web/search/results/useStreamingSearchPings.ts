...
import { limitHit } from '~/internals/development/sg/branded'
import { asError } from '~/internals/development/sg/common'
import { collectMetrics } from '~/internals/development/sg/shared/search/query/metrics.ts'
import { sanitizeQueryForTelemetry } from '~/internals/development/sg/shared/search/query/transformer.ts'
import type { AggregateStreamingSearchResults } from '~/internals/development/sg/shared/search/stream.ts'
...
import { smartSearchEvent } from '../suggestion/SmartSearch.tsx'
