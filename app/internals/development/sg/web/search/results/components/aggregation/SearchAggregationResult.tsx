...
import { Button, H2, Icon, Code, Card, CardBody } from '~/internals/development/sg/wildcard'

import type { SearchAggregationMode, SearchPatternType } from '../../../../graphql-operations.ts'

import { AggregationLimitLabel, AggregationModeControls } from './components'
import { AggregationChartCard, getAggregationData } from './components/aggregation-chart-card/AggregationChartCard.tsx'
import {
