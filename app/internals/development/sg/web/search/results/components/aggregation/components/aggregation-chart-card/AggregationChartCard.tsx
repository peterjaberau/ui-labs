...
import { NotAvailableReasonType, type SearchAggregationMode } from '~/internals/development/sg/shared/graphql-operations.ts'
import { lazyComponent } from '~/internals/development/sg/shared/util/lazyComponent.tsx'
import { Text, Link, Tooltip, Button, Icon, ErrorAlert, ErrorMessage } from '~/internals/development/sg/wildcard'

import type { SearchAggregationDatum, GetSearchAggregationResult } from '../../../../../../graphql-operations.ts'
...
const LazyAggregationChart = lazyComponent<AggregationChartProps<SearchAggregationDatum>, string>(
    () => import('./components/AggregationChart.tsx'),
    'AggregationChart'
)
