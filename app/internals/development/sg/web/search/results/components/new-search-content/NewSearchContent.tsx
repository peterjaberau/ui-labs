...
import { StreamingProgress, StreamingSearchResultsList, useSearchResultState } from '~/internals/development/sg/branded'
import type { FetchFileParameters } from '~/internals/development/sg/shared/backend/file.ts'
import type { FilePrefetcher } from '~/internals/development/sg/shared/components/PrefetchableFile.tsx'
...
} from '~/internals/development/sg/shared/search/stream.ts'
...
import { NOOP_TELEMETRY_SERVICE, type TelemetryProps } from '~/internals/development/sg/shared/telemetry/telemetryService.ts'
import { lazyComponent } from '~/internals/development/sg/shared/util/lazyComponent.tsx'
import { Button, H2, H4, Icon, Link, Panel, useLocalStorage, useScrollManager } from '~/internals/development/sg/wildcard'

import type { AuthenticatedUser } from '../../../../auth.ts'
import type { SearchJobsProps } from '../../../../enterprise/search-jobs'
import { fetchBlob } from '../../../../repo/blob/backend.ts'
import { buildSearchURLQueryFromQueryState } from '../../../../stores'
import { GettingStartedTour } from '../../../../tour/GettingStartedTour.tsx'
import { showQueryExamplesForKeywordSearch } from '../../../../util/settings.ts'
import { DidYouMean } from '../../../suggestion/DidYouMean.tsx'
import { SmartSearch } from '../../../suggestion/SmartSearch.tsx'
import { SearchFiltersSidebar } from '../../sidebar/SearchFiltersSidebar.tsx'
import { AggregationUIMode, SearchAggregationResult } from '../aggregation'
import { SearchFiltersPanel, SearchFiltersTabletButton } from '../filters-panel/SearchFiltersPanel.tsx'
import { SearchResultsInfoBar } from '../search-results-info-bar/SearchResultsInfoBar.tsx'
import { SearchAlert } from '../SearchAlert.tsx'
import { UnownedResultsAlert } from '../UnownedResultsAlert.tsx'
import { isSmartSearchAlert } from '../utils.ts'

import { useIsNewSearchFiltersEnabled } from './use-new-search-filters.ts'

import styles from './NewSearchContent.module.scss'

const LazySideBlob = lazyComponent(() => import('../../../../codeintel/SideBlob.tsx'), 'SideBlob')
