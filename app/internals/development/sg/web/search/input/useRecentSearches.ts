...
import type { SearchHistoryEventLogsQueryResult, SearchHistoryEventLogsQueryVariables } from '../../graphql-operations.ts'

import { RecentSearchesManager } from './recentSearches.ts'
