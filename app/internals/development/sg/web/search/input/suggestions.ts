...
import {
    ...
    defaultLanguages,
    RenderAs,
} from '~/internals/development/sg/branded/search-ui/experimental.ts'
import { getQueryInformation } from '~/internals/development/sg/branded/search-ui/input/codemirror/parsedQuery.ts'
import { gql } from '~/internals/development/sg/http-client'
import { getUserSearchContextNamespaces } from '~/internals/development/sg/shared/search/backend.ts'
import { getRelevantTokens } from '~/internals/development/sg/shared/search/query/analyze.ts'
import { regexInsertText } from '~/internals/development/sg/shared/search/query/completion-utils.ts'
import {
    FILTERS,
    FilterType,
    isNegatableFilter,
    type ResolvedFilter,
} from '~/internals/development/sg/shared/search/query/filters.ts'
import type { Node, Parameter } from '~/internals/development/sg/shared/search/query/parser.ts'
import { predicateCompletion } from '~/internals/development/sg/shared/search/query/predicates.ts'
import { stringHuman } from '~/internals/development/sg/shared/search/query/printer.ts'
import { selectorHasFields } from '~/internals/development/sg/shared/search/query/selectFilter.ts'
import { type CharacterRange, type Filter, KeywordKind, type Token } from '~/internals/development/sg/shared/search/query/token.ts'
import { isFilterOfType, resolveFilterMemoized } from '~/internals/development/sg/shared/search/query/utils.ts'
import { getSymbolIconSVGPath } from '~/internals/development/sg/shared/symbols/symbolIcons.ts'
...
import { CachedAsyncCompletionSource } from '../autocompletion/source.ts'
