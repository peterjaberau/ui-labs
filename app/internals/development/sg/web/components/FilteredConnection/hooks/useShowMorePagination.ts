...
import { useQuery, type GraphQLResult } from '~/internals/development/sg/http-client'
import { useInterval } from '~/internals/development/sg/wildcard'

import type { Connection } from '../ConnectionType.ts'
import { asGraphQLResult, hasNextPage } from '../utils.ts'
...
import { DEFAULT_PAGE_SIZE } from './usePageSwitcherPagination.ts'
