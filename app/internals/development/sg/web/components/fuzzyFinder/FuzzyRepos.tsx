...
import { CodeHostIcon, formatRepositoryStarCount, SearchResultStar } from '~/internals/development/sg/branded'
...
import type { FuzzyFinderRepoResult, FuzzyFinderRepoVariables } from '../../graphql-operations.ts'
import type { UserHistory } from '../useUserHistory.ts'

import { FuzzyStorageCache, type PersistableQueryResult } from './FuzzyLocalCache.ts'
