...
import { Timestamp, TimestampFormat } from '~/internals/development/sg/branded/components/Timestamp'
import { Badge, type BadgeProps, Button, ErrorAlert, Icon } from '~/internals/development/sg/wildcard'

import { type ExternalServiceSyncJobListFields, ExternalServiceSyncJobState } from '../../graphql-operations.ts'
import { ValueLegendList, type ValueLegendListProps } from '../../site-admin/analytics/components/ValueLegendList.tsx'
import { LoaderButton } from '../LoaderButton.tsx'
import { Duration } from '../time/Duration.tsx'

import { useCancelExternalServiceSync } from './backend.ts'
import { EXTERNAL_SERVICE_SYNC_RUNNING_STATUSES } from './externalServices.tsx'
