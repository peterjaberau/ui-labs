...
import { Button, Modal, Text, ErrorAlert, H3, AnchorLink, Alert } from '~/internals/development/sg/wildcard'

import type { DeleteGitHubAppResult, DeleteGitHubAppVariables, GitHubAppByIDFields } from '../../graphql-operations.ts'
import { LoaderButton } from '../LoaderButton.tsx'

import { DELETE_GITHUB_APP_BY_ID_QUERY } from './backend.ts'
