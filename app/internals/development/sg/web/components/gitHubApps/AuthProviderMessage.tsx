...
import { Icon, Button, Alert, Text, Link, Code } from '~/internals/development/sg/wildcard'
...
import { GITHUB_APP_CLIENT_SECRET_QUERY, SITE_SETTINGS_QUERY } from './backend.ts'
