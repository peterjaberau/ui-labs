...
import type { GitHubAppByAppIDResult, GitHubAppByAppIDVariables } from '../../graphql-operations.ts'
import { type ExternalServiceFieldsWithConfig, LIST_EXTERNAL_SERVICE_FRAGMENT } from '../externalServices/backend.ts'
