...
import { codyProRoutes } from './cody/codyProRoutes.tsx'
import { codyRoutes } from './cody/codyRoutes.tsx'
import { communitySearchContextsRoutes } from './communitySearchContexts/routes.tsx'
import { LegacyRoute, type LegacyLayoutRouteContext } from './LegacyRouteContext.tsx'
import { PageRoutes } from './routes.constants.ts'

const SiteAdminArea = lazyComponent(() => import('./site-admin/SiteAdminArea.tsx'), 'SiteAdminArea')
const SignInPage = lazyComponent(() => import('./auth/SignInPage.tsx'), 'SignInPage')
const RequestAccessPage = lazyComponent(() => import('./auth/RequestAccessPage.tsx'), 'RequestAccessPage')
const SignUpPage = lazyComponent(() => import('./auth/SignUpPage.tsx'), 'SignUpPage')
const UnlockAccountPage = lazyComponent(() => import('./auth/UnlockAccount.tsx'), 'UnlockAccountPage')
const SiteInitPage = lazyComponent(() => import('./site-admin/init/SiteInitPage.tsx'), 'SiteInitPage')
const RedirectToUserSettings = lazyComponent(
    () => import('./user/settings/RedirectToUserSettings.tsx'),
    'RedirectToUserSettings'
)
const RedirectToUserPage = lazyComponent(() => import('./user/settings/RedirectToUserPage.tsx'), 'RedirectToUserPage')
const OrgsArea = lazyComponent(() => import('./org/OrgsArea.tsx'), 'OrgsArea')
const ResetPasswordPage = lazyComponent(() => import('./auth/ResetPasswordPage.tsx'), 'ResetPasswordPage')
const ApiConsole = lazyComponent(() => import('./api/ApiConsole.tsx'), 'ApiConsole')
const UserArea = lazyComponent(() => import('./user/area/UserArea.tsx'), 'UserArea')
const SurveyPage = lazyComponent(() => import('./marketing/page/SurveyPage.tsx'), 'SurveyPage')
const RepoContainer = lazyComponent(() => import('./repo/RepoContainer.tsx'), 'RepoContainer')
const TeamsArea = lazyComponent(() => import('./team/TeamsArea.tsx'), 'TeamsArea')
const CodySidebarStoreProvider = lazyComponent(() => import('./cody/sidebar/Provider.tsx'), 'CodySidebarStoreProvider')
const CodyIgnoreProvider = lazyComponent(() => import('./cody/useCodyIgnore.tsx'), 'CodyIgnoreProvider')
const PostSignUpPage = lazyComponent(() => import('./auth/PostSignUpPage.tsx'), 'PostSignUpPage')

const GlobalNotebooksArea = lazyComponent(() => import('./notebooks/GlobalNotebooksArea.tsx'), 'GlobalNotebooksArea')
...
const GlobalCodeMonitoringArea = lazyComponent(
    () => import('./enterprise/code-monitoring/global/GlobalCodeMonitoringArea.tsx'),
    'GlobalCodeMonitoringArea'
)
const CodeInsightsAppRouter = lazyComponent(
    () => import('./enterprise/insights/CodeInsightsAppRouter.tsx'),
    'CodeInsightsAppRouter'
)
const SearchContextsListPage = lazyComponent(
    () => import('./enterprise/searchContexts/SearchContextsListPage.tsx'),
    'SearchContextsListPage'
)
const CreateSearchContextPage = lazyComponent(
    () => import('./enterprise/searchContexts/CreateSearchContextPage.tsx'),
    'CreateSearchContextPage'
)
const EditSearchContextPage = lazyComponent(
    () => import('./enterprise/searchContexts/EditSearchContextPage.tsx'),
    'EditSearchContextPage'
)
const SearchContextPage = lazyComponent(
    () => import('./enterprise/searchContexts/SearchContextPage.tsx'),
    'SearchContextPage'
)
const SearchUpsellPage = lazyComponent(() => import('./search/upsell/SearchUpsellPage.tsx'), 'SearchUpsellPage')
const SearchPageWrapper = lazyComponent(() => import('./search/SearchPageWrapper.tsx'), 'SearchPageWrapper')
const SearchJob = lazyComponent(() => import('./enterprise/search-jobs/SearchJobsPage.tsx'), 'SearchJobsPage')
const SavedSearchArea = lazyComponent(() => import('./savedSearches/Area.tsx'), 'Area')
const PromptsArea = lazyComponent(() => import('./prompts/Area.tsx'), 'Area')

const Index = lazyComponent(() => import('./Index.tsx'), 'IndexPage')
