...
import type { SiteConfiguration } from '~/internals/development/sg/shared/schema/site.schema'
import type { TelemetryRecorder } from '~/internals/development/sg/shared/telemetry'
import type { BatchChangesLicenseInfo } from '~/internals/development/sg/shared/testing/batches'

import type { TemporarySettingsResult } from './graphql-operations.ts'
