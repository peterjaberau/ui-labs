...
import { mergeSettings } from '~/internals/development/sg/shared/settings/settings.tsx'
import { currentUserMock, sharedGraphQlResults } from '~/internals/development/sg/shared/testing/integration/graphQlResults'

import type { WebGraphQlOperations } from '../graphql-operations.ts'

import { builtinAuthProvider, siteGQLID, siteID } from './jscontext.ts'
