import { encodeURIPathComponent } from '~/internals/development/sg/common'
import type { JsonDocument } from '~/internals/development/sg/shared/codeintel/scip.ts'
import { RepositoryType, type TreeEntriesResult } from '~/internals/development/sg/shared/graphql-operations.ts'
