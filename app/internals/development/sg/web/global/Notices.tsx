...
import type { Notice } from '~/internals/development/sg/shared/schema/settings.schema'
...
import { Alert, Markdown, type AlertProps } from '~/internals/development/sg/wildcard'

import type { AuthenticatedUser } from '../auth.ts'
import { currentUserRequiresEmailVerificationForCody } from '../cody/util.ts'
