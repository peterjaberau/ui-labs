...
import { Text, H3, Popover, PopoverTrigger, PopoverContent, Icon, Button } from '~/internals/development/sg/wildcard'

import { LearnMoreOverlay } from './LearnMoreOverlay.tsx'
import { enableSvelteAndReload, canEnableSvelteKit } from './util.ts'
