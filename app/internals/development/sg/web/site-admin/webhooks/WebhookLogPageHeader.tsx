...
import type { WebhookLogPageHeaderResult } from '../../graphql-operations.ts'

import { WEBHOOK_LOG_PAGE_HEADER } from './backend.ts'
import { PerformanceGauge } from './PerformanceGauge.tsx'
