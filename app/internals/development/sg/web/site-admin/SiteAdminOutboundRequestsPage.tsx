...
import { useQuery } from '~/internals/development/sg/http-client/src'
...
import type { OutboundRequestsResult, OutboundRequestsVariables } from '../graphql-operations.ts'

import { OUTBOUND_REQUESTS, OUTBOUND_REQUESTS_PAGE_POLL_INTERVAL_MS } from './backend.ts'
import { parseProductReference } from './SiteAdminFeatureFlagsPage.tsx'
