...
import { type ExternalServiceKind, ExternalServiceSyncJobState } from '~/internals/development/sg/shared/graphql-operations.ts'

import type { ListExternalServiceFields, WebhookFields } from '../graphql-operations.ts'
