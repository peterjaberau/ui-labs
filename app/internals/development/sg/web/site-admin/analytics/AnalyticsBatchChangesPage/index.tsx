...
import { Card, LoadingSpinner, H2, Text, LineChart, type Series } from '~/internals/development/sg/wildcard'

import type { BatchChangesStatisticsResult, BatchChangesStatisticsVariables } from '../../../graphql-operations.ts'
...
import { BATCHCHANGES_STATISTICS } from './queries.ts'
