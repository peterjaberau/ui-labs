...
import type { CodeIntelStatisticsResult, CodeIntelStatisticsVariables } from '../../../graphql-operations.ts'
...
import { TimeSavedCalculatorGroup } from '../components/TimeSavedCalculatorGroup.tsx'
...
import { formatNumber, type StandardDatum } from '../utils.ts'

import { CODEINTEL_STATISTICS } from './queries.ts'
