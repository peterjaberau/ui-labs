...
import { Card, LoadingSpinner, Text, LineChart, type Series, H2 } from '~/internals/development/sg/wildcard'

import type { InsightsStatisticsResult, InsightsStatisticsVariables } from '../../../graphql-operations.ts'
...
import { INSIGHTS_STATISTICS } from './queries.ts'
