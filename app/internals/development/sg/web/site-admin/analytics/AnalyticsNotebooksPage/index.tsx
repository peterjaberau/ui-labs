...
import { Card, LoadingSpinner, H2, Text, H4, AnchorLink, LineChart, type Series } from '~/internals/development/sg/wildcard'

import type { NotebooksStatisticsResult, NotebooksStatisticsVariables } from '../../../graphql-operations.ts'
...
import { TimeSavedCalculator, type TimeSavedCalculatorProps } from '../components/TimeSavedCalculatorGroup.tsx'
...
import { NOTEBOOKS_STATISTICS } from './queries.ts'
