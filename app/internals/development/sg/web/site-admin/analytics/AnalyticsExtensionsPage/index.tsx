...
import { Card, H2, Text, LoadingSpinner, AnchorLink, H4, LineChart, type Series } from '~/internals/development/sg/wildcard'

import type { ExtensionsStatisticsResult, ExtensionsStatisticsVariables } from '../../../graphql-operations.ts'
import { AnalyticsPageTitle } from '../components/AnalyticsPageTitle.tsx'
import { ChartContainer } from '../components/ChartContainer.tsx'
import { HorizontalSelect } from '../components/HorizontalSelect.tsx'
import { TimeSavedCalculatorGroup, TimeSavedCalculatorGroupProps } from '../components/TimeSavedCalculatorGroup.tsx'
import { ToggleSelect } from '../components/ToggleSelect.tsx'
import { ValueLegendList, type ValueLegendListProps } from '../components/ValueLegendList.tsx'
import { useChartFilters } from '../useChartFilters.ts'
import type { StandardDatum } from '../utils.ts'

import { EXTENSIONS_STATISTICS } from './queries.ts'
