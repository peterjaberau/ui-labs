...
import { Button, Icon, LoadingSpinner, Tooltip } from '~/internals/development/sg/wildcard'

import type { DeleteOutboundWebhookResult, DeleteOutboundWebhookVariables } from '../../../graphql-operations.ts'
import { DELETE_OUTBOUND_WEBHOOK } from '../backend.ts'
