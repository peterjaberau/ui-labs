...
import type { ExternalServiceKind } from '~/internals/development/sg/shared/graphql-operations.ts'
...
import { LoadingSpinner, useObservable, Alert, Link, H2, Text } from '~/internals/development/sg/wildcard'
...
import { fetchAllConfigAndSettings } from './backend.ts'
    ...
    return (
        <div>
            ...
            <Text>
                ...
                <Link target="_blank" rel="noopener noreferrer" to="mailto:support@domain.com">
                    support@domain.com
                </Link>{' '}
                instead.
            </Text>
