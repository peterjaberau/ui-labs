...
import { Icon, Select, Tooltip, Input, Button, Form, Label, H3 } from '~/internals/development/sg/wildcard'

import type { SimpleSearchProps } from './CodeSearchSimpleSearch.tsx'
