...
import { type AuthenticatedUser as SharedAuthenticatedUser, currentAuthStateQuery } from '~/internals/development/sg/shared/auth.ts'
import type { CurrentAuthStateResult } from '~/internals/development/sg/shared/graphql-operations.ts'
