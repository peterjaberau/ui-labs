...
import { Alert, Button, type FormChangeEvent, H4, Link, useLocalStorage } from '~/internals/development/sg/wildcard'

import { defaultExternalServices } from '../../../../../components/externalServices/externalServices.tsx'
import { LoaderButton } from '../../../../../components/LoaderButton.tsx'
import type { AddRemoteCodeHostResult, AddRemoteCodeHostVariables } from '../../../../../graphql-operations.ts'
import { ADD_CODE_HOST, CODE_HOST_FRAGMENT } from '../../../../queries.ts'
import { getCodeHostKindFromURLParam } from '../../helpers.tsx'

import { type CodeHostConnectFormFields, CodeHostJSONForm, type CodeHostJSONFormState } from './common'
import { GithubConnectView } from './github/GithubConnectView.tsx'
import { getRepositoriesSettings } from './github/helpers.ts'
