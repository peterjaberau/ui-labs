...
import { modify } from '~/internals/development/sg/common'
import { gql, useLazyQuery } from '~/internals/development/sg/http-client'
...
import { EXTERNAL_SERVICE_CHECK_CONNECTION_BY_ID } from '../../../../../../components/externalServices/backend.ts'
import { codeHostExternalServices } from '../../../../../../components/externalServices/externalServices.tsx'
import type {
...
import { GithubOrganizationsPicker, GithubRepositoriesPicker } from './GithubEntityPickers.tsx'
import { getAccessTokenValue, getRepositoriesSettings } from './helpers.ts'
