...
import { encodeURIPathComponent, pluralize } from '~/internals/development/sg/common'
import { useQuery } from '~/internals/development/sg/http-client'
import { Badge, Button, Link, Icon } from '~/internals/development/sg/wildcard'

import type { RepoChangesetsStatsResult, RepoChangesetsStatsVariables } from '../graphql-operations.ts'

import { REPO_CHANGESETS_STATS } from './backend.ts'
import { BatchChangesIcon } from './icons.tsx'
