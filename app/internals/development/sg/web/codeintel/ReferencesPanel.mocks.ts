...
import { dataOrThrowErrors, getDocumentNode, useQuery } from '~/internals/development/sg/http-client'
import { noOpTelemetryRecorder } from '~/internals/development/sg/shared/telemetry'
...
import { asGraphQLResult } from '../components/FilteredConnection/utils.ts'
import {
...
import { buildPreciseLocation, LocationsGroup } from './location.ts'
import type { ReferencesPanelProps } from './ReferencesPanel.tsx'
import {
    FETCH_HIGHLIGHTED_BLOB,
    RESOLVE_REPO_REVISION_BLOB_QUERY,
    USE_PRECISE_CODE_INTEL_FOR_POSITION_QUERY,
} from './ReferencesPanelQueries.ts'
import type { UseCodeIntelParameters, UseCodeIntelResult } from './useCodeIntel.ts'
