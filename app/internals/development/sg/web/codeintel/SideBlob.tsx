...
import type { Position } from '~/internals/development/sg/extension-api-classes'
...
import { Code, LoadingSpinner, Text } from '~/internals/development/sg/wildcard'
...
import type { SearchPanelConfig } from '../repo/blob/codemirror/search.ts'
import type { Range } from '../repo/blob/codemirror/static-highlights.tsx'
import { CodeMirrorBlob } from '../repo/blob/CodeMirrorBlob.tsx'

import { FETCH_HIGHLIGHTED_BLOB } from './ReferencesPanelQueries.ts'
