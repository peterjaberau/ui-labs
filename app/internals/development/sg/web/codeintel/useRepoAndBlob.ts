...
import type { ResolveRepoAndRevisionResult, ResolveRepoAndRevisionVariables } from '../graphql-operations.ts'

import { RESOLVE_REPO_REVISION_BLOB_QUERY } from './ReferencesPanelQueries.ts'
