...
import type { HighlightedLinkProps, RangePosition } from '../components/fuzzyFinder/HighlightedLink.tsx'
...
import type { SearchValue } from './SearchValue.ts'
import { SearchValueRankingCache } from './SearchValueRankingCache.ts'
