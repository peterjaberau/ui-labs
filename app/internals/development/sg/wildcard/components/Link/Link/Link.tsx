...
import type { ForwardReferenceExoticComponent } from '../../../types.ts'
 ...
 *
 * The web app uses <RouterLinkOrAnchor>, which uses @remix-run/react's <Link> for relative URLs (for page
 * navigation using the HTML history API) and <a> for absolute URLs. The @remix-run/react <Link> component only
 ...
 * @remix-run/react <Link> wouldn't work in the browser extension, because there is no <BrowserRouter>.
 *
