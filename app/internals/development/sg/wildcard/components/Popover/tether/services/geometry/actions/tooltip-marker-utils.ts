...
import { createRectangle, createRectangleFromPoints, type Rectangle } from '../../../models/geometry/rectangle.ts'
import { type ElementPosition, Position } from '../../../models/tether-models.ts'
import { POSITION_VARIANTS } from '../constants.ts'
