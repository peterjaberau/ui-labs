...
import {
    ...
    EMPTY_RECTANGLE,
    type Rectangle,
} from '../models/geometry/rectangle.ts'
import { type Constraint, Flipping, Overlapping, type Padding, Position, Strategy } from '../models/tether-models.ts'

import { getAbsoluteAnchorOffset, getScrollParents } from './tether-browser.ts'
import type { Tether, TetherLayout } from './types.ts'
