import { createPoint, type Point } from '../models/geometry/point.ts'
import { getIntersection, intersects, type Rectangle } from '../models/geometry/rectangle.ts'
import { type ElementPosition, Strategy } from '../models/tether-models.ts'
...
import { getExtendedConstraint } from './geometry/actions/get-extended-constraint.ts'
import type { TetherLayout } from './types.ts'
