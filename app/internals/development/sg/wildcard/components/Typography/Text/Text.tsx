...
import type { TYPOGRAPHY_SIZES, TYPOGRAPHY_WEIGHTS } from '../constants.ts'
import { getModeStyle, getAlignmentStyle, type TypographyProps, getFontWeightStyle } from '../utils.ts'
