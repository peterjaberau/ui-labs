...
import { getPanelData, PanelTransfer } from '../dnd/dataTransfer.ts';
import { Position, WillShowOverlayEvent } from '../dnd/droptarget.ts';
import { DockviewComponent } from './dockviewComponent.ts';
import { isAncestor, toggleClass } from '../dom.ts';
import {
...
import { IViewSize } from '../gridview/gridview.ts';
import { CompositeDisposable, IDisposable } from '../lifecycle.ts';
import {
    IPanel,
    PanelInitParameters,
    PanelUpdateEvent,
...
import {
    ContentContainer,
    IContentContainer,
} from './components/panel/content.ts';
import {
    GroupDragEvent,
    ITabsContainer,
    TabDragEvent,
...
import { IWatermarkRenderer } from './types.ts';
...
import { OverlayRenderContainer } from '../overlay/overlayRenderContainer.ts';
import { TitleEvent } from '../api/dockviewPanelApi.ts';
import { Contraints } from '../gridview/gridviewPanel.ts';
    ...
    implements IDockviewGroupPanelModel
{
    ...
    constructor(
        ...
        this.tabsContainer = new TabsContainer(this.accessor, this.groupPanel) as any;

        this.contentContainer = new ContentContainer(this.accessor, this);

        container.append(
            this.tabsContainer.element as any,
            this.contentContainer.element as any
        );
