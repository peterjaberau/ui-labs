...
import { DockviewEvent, Emitter, Event } from '../events.ts';
import { CompositeDisposable } from '../lifecycle.ts';
import { DragAndDropObserver } from './dnd.ts';
        ...
        this.dnd = new DragAndDropObserver(this.element, {
            ...
            onDragOver: (e) => {
                ...
                if (!this.targetElement) {
                    this.targetElement = document.createElement('div') as HTMLElement;
                    this.targetElement.className = 'dv-drop-target-dropzone';
                    this.overlayElement = document.createElement('div') as HTMLElement;
                    this.overlayElement.className = 'dv-drop-target-selection';
                    this._state = 'center';
                    this.targetElement.appendChild(this.overlayElement);

                    this.element.classList.add('dv-drop-target');
                    this.element.append(this.targetElement as any);
                }
