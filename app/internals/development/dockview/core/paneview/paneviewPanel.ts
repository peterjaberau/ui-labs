...
import { PaneviewPanelApiImpl } from '../api/paneviewPanelApi.ts';
import { addClasses, removeClasses } from '../dom.ts';
import { addDisposableListener, Emitter, Event } from '../events.ts';
import {
    BasePanelView,
    BasePanelViewExported,
    BasePanelViewState,
} from '../gridview/basePanelView.ts';
...
import { IView, Orientation } from '../splitview/splitview.ts';
import { PaneviewComponent } from './paneviewComponent.ts';
    ...
    implements IPaneview, IPaneviewPanel
{
    ...
    init(parameters: PanePanelInitParameter): void {
        ...
        this.body?.append(this.bodyPart.element as any);
        this.header?.append(this.headerPart.element as any);
