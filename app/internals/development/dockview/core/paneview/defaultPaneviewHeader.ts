import { addDisposableListener } from '../events.ts';
import { PaneviewPanelApiImpl } from '../api/paneviewPanelApi.ts';
import { CompositeDisposable, MutableDisposable } from '../lifecycle.ts';
import { PanelUpdateEvent } from '../panel/types.ts';
import { IPanePart, PanePanelInitParameter } from './paneviewPanel.ts';
import { toggleClass } from '../dom.ts';
import { createChevronRightButton, createExpandMoreButton } from '../svg.ts';
