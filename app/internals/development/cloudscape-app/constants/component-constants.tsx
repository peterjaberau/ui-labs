...
export const appLayoutI18nStrings: any = {
...
export const itemsPaletteI18nStrings: any = {
  ...
  navigationItemAriaLabel: (item: any) => item.data.title,
};

function createAnnouncement(operationAnnouncement: string, conflicts: readonly BoardProps.Item[], disturbed: readonly BoardProps.Item[]) {
