...
import {
    ...
    defaultLanguages,
    RenderAs,
} from '~/sg/branded/search-ui/experimental'
import { getQueryInformation } from '~/sg/branded/search-ui/input/codemirror/parsedQuery'
import { gql } from '~/sg/http-client'
import { getUserSearchContextNamespaces } from '~/sg/shared/search/backend'
import { getRelevantTokens } from '~/sg/shared/search/query/analyze'
import { regexInsertText } from '~/sg/shared/search/query/completion-utils'
import {
    FILTERS,
    FilterType,
    isNegatableFilter,
    type ResolvedFilter,
} from '~/sg/shared/search/query/filters'
import type { Node, Parameter } from '~/sg/shared/search/query/parser'
import { predicateCompletion } from '~/sg/shared/search/query/predicates'
import { stringHuman } from '~/sg/shared/search/query/printer'
import { selectorHasFields } from '~/sg/shared/search/query/selectFilter'
import { type CharacterRange, type Filter, KeywordKind, type Token } from '~/sg/shared/search/query/token'
import { isFilterOfType, resolveFilterMemoized } from '~/sg/shared/search/query/utils'
import { getSymbolIconSVGPath } from '~/sg/shared/symbols/symbolIcons'
