...
import { memoizeObservable } from '~/sg/common'
import { SearchPatternType } from '~/sg/shared/graphql-operations'
import { discreteValueAliases, escapeSpaces } from '~/sg/shared/search/query/filters'
import { findFilter, FilterKind, getGlobalSearchContextFilter } from '~/sg/shared/search/query/query'
...
import { SearchMode } from '~/sg/shared/search/types'
