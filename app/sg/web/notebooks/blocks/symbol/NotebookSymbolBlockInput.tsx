...
import { createDefaultSuggestions, RepoFileLink } from '~/sg/branded'
import { SearchPatternType } from '~/sg/shared/graphql-operations'
import { getFileMatchUrl, getRepositoryUrl, type SymbolMatch } from '~/sg/shared/search/stream'
...
import { Button, Code } from '~/sg/wildcard'
