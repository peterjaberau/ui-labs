...
import { BaseCodeMirrorQueryInput } from '~/sg/branded/search-ui/input/BaseCodeMirrorQueryInput'
import { dataOrThrowErrors, gql } from '~/sg/http-client'
import { UserAvatar } from '~/sg/shared/components/UserAvatar'
import { SearchJobsOrderBy, SearchJobState, SearchPatternType } from '~/sg/shared/graphql-operations'
import { detectPatternType } from '~/sg/shared/search/query/scanner'
