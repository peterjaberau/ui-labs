...
import { createAggregateError, type ErrorLike } from '~/sg/common'
import type { Range as ExtensionRange, Position as ExtensionPosition } from '~/sg/extension-api-types'
import { getDocumentNode } from '~/sg/http-client'
import { Position as ScipPosition } from '~/sg/shared/codeintel/scip'
