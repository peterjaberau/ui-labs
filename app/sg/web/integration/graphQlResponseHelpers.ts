import { encodeURIPathComponent } from '~/sg/common'
import type { JsonDocument } from '~/sg/shared/codeintel/scip'
import { RepositoryType, type TreeEntriesResult } from '~/sg/shared/graphql-operations'
