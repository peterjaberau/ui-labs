import type { SharedGraphQlOperations } from '~/sg/shared/graphql-operations'
import type { SearchEvent } from '~/sg/shared/search/stream'
import type { TemporarySettings } from '~/sg/shared/settings/temporary/TemporarySettings'
import { getConfig } from '~/sg/shared/testing/config'
import {
    createSharedIntegrationTestContext,
    type IntegrationTestContext,
    type IntegrationTestOptions,
} from '~/sg/shared/testing/integration/context'
