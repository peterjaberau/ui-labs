...
import { dataOrThrowErrors } from '~/sg/http-client'
import { type AuthenticatedUser as SharedAuthenticatedUser, currentAuthStateQuery } from '~/sg/shared/auth'
import type { CurrentAuthStateResult } from '~/sg/shared/graphql-operations'
