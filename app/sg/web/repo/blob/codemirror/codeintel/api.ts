...
import { isMacPlatform } from '~/sg/common'
import { MarkupKind } from '~/sg/extension-api-classes'
import type { Range } from '~/sg/extension-api-types'
import type { ActionItemAction } from '~/sg/shared/actions/ActionItem'
import {
    type CodeIntelAPI,
    findLanguageMatchingDocument,
    hasFindImplementationsSupport,
} from '~/sg/shared/codeintel/api'
import type { Occurrence } from '~/sg/shared/codeintel/scip'
import { makeRepoGitURI, parseRepoGitURI } from '~/sg/shared/util/url'
import type { UIRangeSpec } from '~/sg/shared/util/url'
