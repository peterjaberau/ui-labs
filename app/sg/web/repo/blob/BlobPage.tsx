...
import { TabbedPanelContent } from '~/sg/branded/components/panel/TabbedPanelContent'
import { NoopEditor } from '~/sg/chat-shared'
import { asError, basename, isErrorLike, SourcegraphURL, type ErrorLike } from '~/sg/common'
import {
    createActiveSpan,
    reactManualTracer,
    TraceSpanProvider,
    useCurrentSpan,
} from '~/sg/observability-client'
import type { FetchFileParameters } from '~/sg/shared/backend/file'
import { HighlightResponseFormat, SearchPatternType } from '~/sg/shared/graphql-operations'
import type { PlatformContextProps } from '~/sg/shared/platform/context'
import type { SearchContextProps } from '~/sg/shared/search'
import { useExperimentalFeatures, type SettingsCascadeProps } from '~/sg/shared/settings/settings'
...
import { type ModeSpec, type RepoFile } from '~/sg/shared/util/url'
import {
    Alert,
    Button,
    ButtonLink,
