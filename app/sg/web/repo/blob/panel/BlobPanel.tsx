...
import { type Panel, useBuiltinTabbedPanelViews } from '~/sg/branded/components/panel/TabbedPanelContent'
import { PanelContent } from '~/sg/branded/components/panel/views/PanelContent'
import { SourcegraphURL, isDefined, isErrorLike } from '~/sg/common'
...
import type { Settings, SettingsCascadeOrError, SettingsCascadeProps } from '~/sg/shared/settings/settings'
...
import { type AbsoluteRepoFile, type ModeSpec } from '~/sg/shared/util/url'
