...
import { ContributableMenu, type TextDocumentPositionParameters } from '~/sg/client-api'
import { type HoveredToken, LOADER_DELAY, type MaybeLoadingResult, emitLoading } from '~/sg/codeintellify'
import {
    asError,
    compatNavigate,
    type ErrorLike,
...
import type { Location } from '~/sg/extension-api-types'
import type { Context } from '~/sg/template-parser'
