...
import { useCompartment } from '~/sg/shared/components/CodeMirrorEditor'
...
import { QueryChangeSource } from '~/sg/shared/search'
import { appendContextFilter } from '~/sg/shared/search/query/transformer'
import { fetchStreamSuggestions as defaultFetchStreamSuggestions } from '~/sg/shared/search/suggestions'
import type { RecentSearch } from '~/sg/shared/settings/temporary/recentSearches'
import { isInputElement } from '~/sg/shared/util/dom'
