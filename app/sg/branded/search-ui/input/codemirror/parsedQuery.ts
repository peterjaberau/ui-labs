...
import { decorate, type DecoratedToken } from '~/sg/shared/search/query/decoratedToken'
import { type ParseResult, parseSearchQuery, type Node } from '~/sg/shared/search/query/parser'
import { detectPatternType, scanSearchQuery } from '~/sg/shared/search/query/scanner'
