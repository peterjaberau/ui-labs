 ...
 *
 * @deprecated Use TelemetryV2Props for a '@.../telemetry' implementation
 * instead.
 */
 ...
 *
 * @deprecated Use a '@.../telemetry' implementation instead.
 */
export interface TelemetryService {
    /**
     * Log an event (by sending it to the server).
     *
     * @deprecated Use a '@.../telemetry' implementation instead where
     * available.
     */
