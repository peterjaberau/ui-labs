...
import { NonCancelableEventHandler } from '~/apps/design-systems/cloudscape/internals/types';
import Table, { SelectionChangeDetail } from '~/apps/design-systems/cloudscape/components/Table';

import data, { Order } from '../data.ts';
...
const columnDefinitions = [
  ...
  },
  {
    ...
    width: 150,
    header: 'Total',
    cell: (data: any) => <Box textAlign="right">${data.amount}</Box>,
    sortingField: 'amount',
  },
  {
    id: 'discounted',
