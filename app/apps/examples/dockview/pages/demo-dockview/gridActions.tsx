...
export const GridActions = (props: {
    ...
    return (
      ...
      <Flex vertical={false} wrap={true} gap={6} >
        <Button onClick={() => onAddPanel({ nested: true })}>Add Nested Panel</Button>
        <Button onClick={onAddGroup}>Add Group</Button>
        <Button onClick={props.toggleCustomWatermark}>
          {props.hasCustomWatermark ? 'Disable Custom Watermark' : 'Use Custom Watermark'}
        </Button>
        <Button onClick={onClear}>Clear</Button>
        <Button onClick={onLoad}>Load</Button>
        <Button onClick={onSave}>Save</Button>
        <Button onClick={onReset}>Reset</Button>
        <Button onClick={() => setGap(0)}>Reset Gap</Button>
      </Flex>
